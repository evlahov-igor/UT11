...
Процедура ЗакрыватьОУПриИзменении(Элемент)
	...
	Если ЗакрыватьОперативныйУчетВПрошломПериоде Тогда
...
Процедура ЗакрыватьРУПриИзменении(Элемент)
	...
	Если ЗакрыватьРегламентированныйУчетВПрошломПериоде Тогда
...
Процедура ЗакрыватьМУПриИзменении(Элемент)
	...
	Если ЗакрыватьМеждународныйУчетВПрошломПериоде Тогда
