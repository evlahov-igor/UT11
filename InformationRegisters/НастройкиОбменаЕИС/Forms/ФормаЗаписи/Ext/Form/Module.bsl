...
&НаСервереБезКонтекста
Функция ЭтоОрганизацияЗаказчик(ТипОрганизации)
	
	Возврат ТипОрганизации = Перечисления.ВидыУчастниковЭлектронногоАктированияЕИС.Заказчик;
...
Процедура УправлениеДоступностьюЭУ()
	...
	Элементы.КодПоСПЗ.Видимость = ЭтоОрганизацияЗаказчик(Запись.ТипОрганизации);
