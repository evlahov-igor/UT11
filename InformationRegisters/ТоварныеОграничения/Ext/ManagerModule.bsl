	...
	Пока Истина Цикл
		...
		Попытка
			...
			Запрос.Текст = 
				...
				// << 28.03.2023 Марченко С.Н., КРОК, JIRA№A2105505-1456
				|	ТоварныеОграничения.КР_ЭтапИзмененияАссортимента КАК КР_ЭтапИзмененияАссортимента,  
				// >> 28.03.2023 Марченко С.Н., КРОК, JIRA№A2105505-1456
...
Процедура ОбновитьЗначенияРеквизитаДопУпорядочивания(Номенклатура, Характеристика)
	...
	// << 28.03.2023 Марченко С.Н., КРОК, JIRA№A2105505-1456
	|	Таблица.КР_ЭтапИзмененияАссортимента КАК КР_ЭтапИзмененияАссортимента,  
	// >> 28.03.2023 Марченко С.Н., КРОК, JIRA№A2105505-1456
	...
	// << 28.03.2023 Марченко С.Н., КРОК, JIRA№A2105505-1456
	|	Таблица.КР_ЭтапИзмененияАссортимента,  
	// >> 28.03.2023 Марченко С.Н., КРОК, JIRA№A2105505-1456
