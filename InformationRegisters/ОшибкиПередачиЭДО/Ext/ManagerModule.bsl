...
Процедура ОбработатьДанные_ЗаполнитьИдентификаторОшибки(Набор, ИдентификаторыОшибок, Записать)
	...
	Для каждого Запись Из Набор Цикл
		...
		Если ИдентификаторОшибки = Неопределено Тогда
			Набор.Очистить();
			Записать = Истина;
...
Функция ИдентификаторыОшибок(ИдентификаторыДокументооборотов)
	...
	Для Каждого ИдентификаторДокуменооборота Из ИдентификаторыДокументооборотов Цикл
		НоваяСтрока = ТаблицаИдентификаторыДокументооборотов.Добавить();
		НоваяСтрока.ИдентификаторДокументооборота = ИдентификаторДокуменооборота;
	КонецЦикла;
