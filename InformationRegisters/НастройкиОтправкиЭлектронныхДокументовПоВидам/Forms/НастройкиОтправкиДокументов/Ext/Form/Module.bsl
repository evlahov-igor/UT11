...
Процедура ПолучитьУПД_УКД()
	...
	ИспользованиеУПД_УКД = НастройкиОтправкиЭДОСлужебный.ИспользуетсяУПД_УКД(КлючНастроек);
	
	ИспользоватьУПД = ИспользованиеУПД_УКД.ИспользуетсяУПД;
	ИспользоватьУКД = ИспользованиеУПД_УКД.ИспользуетсяУКД;
