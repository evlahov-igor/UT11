...
Функция СохранитьНастройкиНоменклатуры()
	...
	Попытка
		...
		ИначеЕсли ВариантИспользованияЕдиницыХранения = Перечисления.ВариантыИспользованияЕдиницыХраненияИСМП.ЗаданУпаковками Тогда
			...
			КоличествоВПотребительскойУпаковке = Неопределено;
			ИнтеграцияИСПереопределяемый.ПриОпределенииКоэффициентаУпаковкиНоменклатуры(Номенклатура, ПотребительскаяУпаковка, КоличествоВПотребительскойУпаковке);
...
Процедура НастроитьЭлементыФормыНаСервере()
	...
	ЭтоМолочнаяПродукцияИСМП          = ИнтеграцияИСКлиентСервер.ЭтоМолочнаяПродукцияИСМП(ВидПродукции);
	...
	Элементы.ВариантЕдиницыИзмеренияИмеетФиксированныйВес.Видимость   = ЭтоМолочнаяПродукцияИСМП И (ЭтоФасованнаяПродукция Или Не ДопустимоИспользованиеУпаковок);
	Элементы.ВариантЕдиницыИзмеренияИмеетФиксированныйВес.Доступность = (ЭтоМолочнаяПродукцияИСМП И Не ДопустимоИспользованиеУпаковок);
	Элементы.ПолеКоличествоФиксированныйВес.Видимость                 = ЭтоМолочнаяПродукцияИСМП И (ЭтоФасованнаяПродукция Или Не ДопустимоИспользованиеУпаковок);
	Элементы.ВариантЕдиницыИзмеренияТребуетсяВзвешивание.Видимость    = ЭтоМолочнаяПродукцияИСМП И (ДоступноТребуетВзвешивания Или ЭтоТребуетВзвешивания);
	Элементы.ВариантЕдиницыИзмеренияТребуетсяВзвешивание.Доступность  = ЭтоМолочнаяПродукцияИСМП И ДоступноТребуетВзвешивания;
