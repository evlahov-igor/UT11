...
Процедура ПоместитьТоварыВХранилище() 
	...
	ОтборВыбранныхСтрок = Новый Структура("Выбран", Истина);
	СоставКолонокВыгрузки = "Номенклатура,
							|Характеристика, 
							|Назначение,
							|СтавкаНДС, 
							|Количество, 
							|КоличествоУпаковок, 
							|КоличествоУпаковокВыбран, 
							|СуммаСНДС, 
							|СуммаНДС, 
							|Сумма, 
							|СтавкаНДС,
	...
	ТаблицаТовары = Товары.Выгрузить(ОтборВыбранныхСтрок, СоставКолонокВыгрузки);
	...
	Для Каждого СтрокаТаблицы Из ТаблицаТовары Цикл
		...
		СтрокаТаблицы.ЗаказКлиента       = СтрокаТаблицы.Назначение.Заказ;
	КонецЦикла;
...
Процедура ЗаполнитьТаблицуТоваровДляОтчетаОЗакупках()
	...
	Запрос.УстановитьПараметр("МассивДокументовПриобретения", Новый Массив);
