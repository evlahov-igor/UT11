...
// Возвращает признак использования ЕНП для организации.
// Параметры:
//	Организация - СправочникСсылка.Организации- организация, для которых необходимо определить применение ЕНП;
//	Период - Дата - дата, которой определяется признак применения ЕНП.
//
// Возвращаемое значение:
//	Булево - Истина, если для организации установлено использование единого налогового платежа в учетной политике на дату.
//				В противном случае - ложь.
//
Функция ПлательщикЕНП(Знач Организация, Период) Экспорт
