...
Процедура ЗаполнитьЛокальныеДокументыОбеспечения(ДополнительныеДокументы) Экспорт
	...
	ДополнительныеДокументы.КонтрольныеРегистрыИзменений.Вставить("РаспределениеЗапасовДвижения", Новый Массив);
	ДополнительныеДокументы.КонтрольныеРегистрыИзменений.РаспределениеЗапасовДвижения.Добавить(Тип("ДокументОбъект.МаркировкаТоваровГИСМ"));
	ДополнительныеДокументы.КонтрольныеРегистрыИзменений.РаспределениеЗапасовДвижения.Добавить(Тип("ДокументОбъект.ПеремаркировкаТоваровГИСМ"));
	//-- Локализация
	Возврат;
