...
Процедура ДополнитьОписанияКодовМаркировки(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля) Экспорт
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.НикотиносодержащаяПродукция Тогда
		...
		ОписаниеКодаМаркировкиПродукцииНикотиносодержащаяПродукцияГрупповая(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля);
		
		ОписаниеКодаМаркировкиПродукцииНикотиносодержащаяПродукцияПотребительская(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля);
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.БАДы Тогда
		...
		ОписаниеКодаМаркировкиПродукцииБАДы(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля);
		
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.Антисептики Тогда
		
		ОписаниеКодаМаркировкиПродукцииАнтисептики(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля);
...
Процедура ОписаниеКодаМаркировкиПродукцииПиво(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля)
...
Процедура ОписаниеКодаМаркировкиПродукцииНикотиносодержащаяПродукцияГрупповая(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля)
...
Процедура ОписаниеКодаМаркировкиПродукцииНикотиносодержащаяПродукцияПотребительская(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля)
...
Процедура ОписаниеКодаМаркировкиПродукцииБАДы(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля)
...
Процедура ОписаниеКодаМаркировкиПродукцииАнтисептики(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля)
