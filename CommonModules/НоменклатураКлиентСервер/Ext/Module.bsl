...
// << 06.02.2024 Петухов А.В., Фактор, #3705
...
#Если Сервер Тогда
	мсвДопРеквизиты = Новый Массив();
	Если ТипЗнч(Номенклатура) = Тип("СправочникСсылка.Номенклатура") Тогда
		Артикул = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Номенклатура,"Артикул");
	КонецЕсли;
	Если ТипЗнч(Характеристика) = Тип("СправочникСсылка.ХарактеристикиНоменклатуры") И ЗначениеЗаполнено(Характеристика) Тогда
		ШтрихКод = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Характеристика,"КР_Штрихкод");
	КонецЕсли;
#Иначе
	Артикул = "";
	ШтрихКод = "";
#КонецЕсли
	...
	Возврат СтрШаблон("%1, %2 %3 / %4 / %5 / %6",Артикул,ШтрихКод,Номенклатура,Характеристика,Назначение,Серия);
