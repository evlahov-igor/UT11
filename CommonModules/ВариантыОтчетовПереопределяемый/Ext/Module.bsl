...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	КР_ЛокализацияИнформационнойБазы.НастроитьВариантыОтчетов(Настройки);
	// >> 14.03.2023 Марченко С.Н., КРОК, JIRA№A2105505-1404
...
Процедура ПередДобавлениемКомандОтчетов(КомандыОтчетов, Параметры, СтандартнаяОбработка) Экспорт
	...
	// << 14.03.2023 Марченко С.Н., КРОК, JIRA№A2105505-1404  
	КР_ЛокализацияИнформационнойБазы.ПередДобавлениемКомандОтчетов(КомандыОтчетов, Параметры, СтандартнаяОбработка);
	// >> 14.03.2023 Марченко С.Н., КРОК, JIRA№A2105505-1404
