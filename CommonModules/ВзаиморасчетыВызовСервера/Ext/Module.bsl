...
// 
Процедура ФормаПередЗаписьюНаСервере(Форма) Экспорт
	ДополненныеПараметры = ОбщегоНазначенияУТКлиентСервер.ПолучитьДанныеМеханизмаИзКэшаФормы(Форма, "Взаиморасчеты");
	ВзаиморасчетыСервер.ПроверитьЗаполнитьЭтапыГрафикаОплаты(Форма, ДополненныеПараметры.МассивПараметров, ДополненныеПараметры.СистемныеНастройки);
...
Процедура ОбъектРасчетовОснованиеПлатежаОбработкаПолученияДанныхВыбора(ДанныеВыбора, НастройкиПодбора, ЭтоУИП, ЭтоОбъектРасчетов) Экспорт
	...
	Если Не ЭтоОбъектРасчетов Тогда
		НастройкиПодбора.Вставить("ПодборДебиторскойЗадолженности", НастройкиПодбора.ПодборДебиторскойЗадолженности);
