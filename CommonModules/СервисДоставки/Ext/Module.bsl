...
Функция ЗапросСервисаСозданиеИзменениеЗаказаНаДоставку(ПараметрыЗапроса, Отказ = Неопределено)
	...
	ДобавитьЗначение(Данные, "shipment.nearestTime", Параметры.ОтгрузкаНаБлижайшееВремя, Истина);
...
Процедура ОбработатьРезультатЗапросаПолучитьЗаказНаДоставку(СтруктураОтвета, Результат)
	...
	ПараметрыЗаказа.Вставить("ОтгрузкаНаБлижайшееВремя", ПолучитьЗначение(Данные, "shipment.nearestTime","Булево", Ложь));
...
Процедура ОбработатьРезультатЗапросаПолучитьМультизаказНаДоставку(СтруктураОтвета, Результат)
	...
	ПараметрыМультизаказа.Вставить("ОтгрузкаНаБлижайшееВремя", ПолучитьЗначение(Данные, "shipment.nearestTime","Булево", Ложь));
