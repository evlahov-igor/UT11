...
Функция НастройкиФормы(Форма) Экспорт
	...
	// --> Евлахов Игорь Николаевич (Начало) 31.05.2024
	// Задача #4182
	ИначеЕсли Форма = ПредопределенноеЗначение("Перечисление.ФормыОткрываемыеПриНачалеРаботыСистемы.злРабочееМестоСотрудникаМагазина") Тогда
		
		СтруктураПараметров.Вставить("ИмяЗапускаемойФормы", "Обработка.злРабочееМестоСотрудникаМагазина.Форма");
		СтруктураПараметров.Вставить("Роль",                "злИспользованиеРабочегоМестаСотрудникаМагазина");
		СтруктураПараметров.Вставить("ПараметрЗапуска",     "WorkplaceStoreEmployee");
	// Задача #4182
	// <-- Евлахов Игорь Николаевич (Конец) 31.05.2024
	КонецЕсли;
