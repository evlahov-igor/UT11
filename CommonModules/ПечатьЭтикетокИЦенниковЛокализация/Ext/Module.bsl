...
Процедура СформироватьПечатнуюФормуЭтикеткиАкцизныеМарки(ДанныеПечати, ОбъектыПечати, СтруктураНастроек, ТабличныйДокумент) Экспорт
	...
	СтруктураРезультата = ОбработкаПечатьЭтикетокИЦенников.ПодготовитьСтруктуруДанных(СтруктураНастроек, "АкцизныеМарки");
...
Процедура ПечатьЭтикетокОбувь(ТаблицаДанных, ТабличныйДокумент, СтруктураНастроек) Экспорт
	...
	СтруктураРезультата = ОбработкаПечатьЭтикетокИЦенников.ПодготовитьСтруктуруДанных(
...
Функция НоваяТаблицаШтрихкодовУпаковок() Экспорт
	...
	Если ЦенообразованиеВызовСервера.ИспользуетсяЦенообразование25() Тогда
		МетаданныеТаблицы = Метаданные.Обработки.ПечатьЭтикетокИЦенников2_5.ТабличныеЧасти.ШтрихкодыУпаковок;
	Иначе
