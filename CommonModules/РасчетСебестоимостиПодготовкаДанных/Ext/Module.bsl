...
Процедура ИсправитьПроблемыВДвиженияхИДокументах(ПараметрыРасчета)
	...
	РасшифровкаКодовОшибок.Вставить(61, НСтр("ru='Неправильный раздел учета для давальческих материалов.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок = Новый Соответствие;
	РасшифровкаКодовОшибок.Вставить(1, НСтр("ru='Неправильный вид движения для документа ""Корректировка приобретения"".'", ОбщегоНазначения.КодОсновногоЯзыка()));
