...
Процедура КорректировочныйСчетФактура(МассивСсылок, ПараметрыВыполнения) Экспорт
	...
	ИначеЕсли РеквизитыДляОбработки.Корректировочный Тогда
		...
		Если РеквизитыДляОбработки.Свойство("Перевыставленный") И РеквизитыДляОбработки.Перевыставленный <> Неопределено Тогда
						
			ТекстСообщения = НСтр("ru='Для выбранного документа нельзя ввести корректировочный счет-фактуры.'");
	...
	ИначеЕсли РеквизитыДляОбработки.Свойство("Перевыставленный") И РеквизитыДляОбработки.Перевыставленный <> Неопределено Тогда
