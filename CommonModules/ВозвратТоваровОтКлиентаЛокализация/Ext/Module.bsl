...
//	МассивОбъектов - Массив из ДокументСсылка.ВозвратТоваровОтКлиента - Массив ссылок на документы, 
...
Процедура ЗаполнитьДокументНаОснованииЧекаККМ(Объект, Знач ДокументОснование)
	...
	Если ВыборкаШапка.Статус <> Перечисления.СтатусыЧековККМ.Пробит Тогда
