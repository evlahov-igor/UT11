...
Функция ПреобразоватьВПараметрыОткрытияФормыУточнения(КодМаркировкиДляУточнения)
	...
	Если ДанныеШтрихкода.ВидУпаковки = ПредопределенноеЗначение("Перечисление.ВидыУпаковокИС.Групповая")
		И (ДанныеШтрихкода.КоличествоГрупповыхУпаковок = 0 Или ДанныеШтрихкода.ПлановоеКоличествоПотребительскихУпаковок <= 2) Тогда
		ДанныеДляУточнения.УточнитьКоличествоПотребительскихУпаковок = Истина;
