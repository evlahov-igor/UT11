...
Функция ШаблонКодаМаркировки(Знач ЗначениеПоиска) Экспорт
	...
	ИначеЕсли ЗначениеПоиска = 21 Тогда
		Результат = Перечисления.ШаблоныКодовМаркировкиСУЗ.НикотиносодержащаяПродукцияБлок;
	...
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.УпакованнаяВода Тогда
		Результат = 16;
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.Пиво Тогда
		Результат = 18;
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.МолочнаяПродукцияСерия6СимволовВЕТИС
		...
		Результат = 20;
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.НикотиносодержащаяПродукцияБлок Тогда
		Результат = 21;
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.НикотиносодержащаяПродукцияПачка Тогда
		Результат = 22;
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.БАДы Тогда
		Результат = 23;
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.Антисептики Тогда
		Результат = 25;
	Иначе
		ВызватьИсключение
			СтрШаблон(
...
Функция ТипКодаМаркировки(Знач ЗначениеПоиска) Экспорт
	...
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.Духи
		...
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.МолочнаяПродукцияСерия6СимволовВЕТИС
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.Антисептики
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.БАДы
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.НикотиносодержащаяПродукцияПачка
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.Пиво Тогда
		Результат = "UNIT";
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.ДухиКомплект
		...
		Результат = "BUNDLE";
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.АльтернативныйТабакБлок
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.НикотиносодержащаяПродукцияБлок Тогда
		Результат = "GROUP";
	Иначе
		ВызватьИсключение
			СтрШаблон(
