...
Процедура ОткрытьФормуОбращенияВТехПоддержку(ДанныеДляТехПоддержки, СтандартнаяОбработка) Экспорт
	...
	ПараметрыФормы.Вставить("СообщениеОбОшибкеОписаниеОшибки", ДанныеДляТехПоддержки.ТекстОбращения);
	
	ОткрытьФорму("Обработка.ПомощникОбращенияВТехническуюПоддержку.Форма", ПараметрыФормы);
	//-- НЕ ГОСИС
