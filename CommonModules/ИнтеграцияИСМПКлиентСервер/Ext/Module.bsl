...
// * СсылкаНаОбъект                    - ПеречисленияСсылка.ВидыПродукцииИС - Вид продукции. Если не заполнено, то вид продукции получается по ссылке.
// * ВидПродукции                      - ПеречисленияСсылка.ВидыПродукцииИС - Вид продукции. Если не заполнено, то вид продукции получается по ссылке.
