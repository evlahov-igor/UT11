...
Функция ПолучитьМатрицуСостояний() Экспорт
	...
	Если Метаданные.ВариантВстроенногоЯзыка = Метаданные.СвойстваОбъектов.ВариантВстроенногоЯзыка.Русский Тогда
		НазваниеМакета = "МатрицаСостоянийПоказателей_ru"
	Иначе
		НазваниеМакета = "МатрицаСостоянийПоказателей_en"
	КонецЕсли;
	МакетМатрицаСостоянийПоказателей = Отчеты.МониторЦелевыхПоказателей.ПолучитьМакет(НазваниеМакета);
