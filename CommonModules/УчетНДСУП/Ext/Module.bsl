...
//
Процедура ЗаполнитьСтавкуНДСДляПлатежей(СтавкаНДС, ТипНалогообложенияНДС, Организация, Дата) Экспорт
...
//  Булево
//
Функция СтавкаНДСКорректна(СтавкаНДС, ТипНалогообложенияНДС, Организация, Дата) Экспорт
...
Процедура УстановитьУсловноеОформлениеСуммНДСПоСтавкеНДСЗакупки(Форма,
	...
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.ВСписке;
	ПравоеЗначение = СписокНезначащихСтавок();
...
//
// Возвращаемое значение:
//  Структура - Cм. ПроведениеДокументов.ПараметрыУчетногоМеханизма
//
...
// 	     * ХозяйственнаяОперация - ПеречислениеСсылка.ХозяйственныеОперации - Хозяйственная операция документа.
// 	     * Организация - СправочникСсылка.Организации - Организация, в которой отражается приобретение.
// 	     * Контрагент - СправочникСсылка.Контрагенты, СправочникСсылка.Организаци	и - Поставщик ценностей.
...
// 	Организация - СправочникСсылка.Организации, Массив - Организация или массив организаций для отбора заданий.
...
// Добавляет в переданную таблицу хозяйственные операции и документы учета НДС для журнала документов Переработки 2.5
//
// Параметры:
//  ТЗХозОперацииИТипыДокументов - ТаблицаЗначений - Состав колонок см. Обработка.ЖурналДокументовПередачиВПереработку2_5.Форма.СписокДокументов.ХозяйственныеОперацииИДокументы
//
