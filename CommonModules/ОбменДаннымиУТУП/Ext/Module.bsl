...
Функция ОпределитьПараметрыЗапросаОбъекта(ЭлементДанных, ТипЗначенияОбъекта = Неопределено, ФормироватьИерархию = Истина) Экспорт
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("ДокументОбъект.ЗаявкаНаВыпускКиЗГИСМ")
		...
		Или ТипЗначенияОбъекта = Тип("ДокументОбъект.ЗаказНаЭмиссиюКодовМаркировкиСУЗ") Тогда
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("РегистрНакопленияЗапись.РаспределениеЗапасовДвижения") Тогда
		
		ЗначенияФильтра_РегистрыНакопления_РаспределениеЗапасовДвижения(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
...
Процедура ЗначенияФильтра_РегистрыНакопления_РаспределениеЗапасовДвижения(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	ОтборПоПодразделениюИзРеквизита(Объект, ПараметрыЗапроса, ФормироватьИерархию, "Склад");
КонецПроцедуры
