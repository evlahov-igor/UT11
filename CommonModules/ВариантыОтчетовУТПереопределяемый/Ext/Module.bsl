...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	// << 27.03.2023 Федотов А.М., КРОК, Jira№A2105505-371
	#Область КР_ДополнительныеОтчеты
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.КР_СостояниеИнтеграции);
	ОписаниеОтчета.ВидимостьПоУмолчанию = Ложь;
	ОписаниеОтчета.Описание = НСтр("ru= 'Состояние интеграции'");
	ОписаниеОтчета.Размещение.Очистить();
	
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.КР_ОшибкиПоискаДанныхИнтеграции);
	ОписаниеОтчета.ВидимостьПоУмолчанию = Ложь;
	ОписаниеОтчета.Описание = НСтр("ru= 'Ошибки поиска данных интеграции'");
	ОписаниеОтчета.Размещение.Очистить();
	
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.КР_НаличиеПакетовИнтеграцииПоОбъекту);
	ОписаниеОтчета.ВидимостьПоУмолчанию = Ложь;
	ОписаниеОтчета.Описание = НСтр("ru= 'Наличие пакетов интеграции по объекту'");
	ОписаниеОтчета.Размещение.Очистить();
	
	// << 17.04.2023, Маскаев П.Ю., КРОК, Jira№ A2105505-1531
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.КР_ДинамикаСкоростиРазбораСообщений);
	ОписаниеОтчета.ВидимостьПоУмолчанию = Ложь;
	ОписаниеОтчета.Описание = НСтр("ru= 'Динамика скорости разбора сообщений'");
	ОписаниеОтчета.Размещение.Очистить();
	// >> 17.04.2023, Маскаев П.Ю., КРОК, Jira№ A2105505-1531
	#КонецОбласти
	// >> 27.03.2023 Федотов А.М., КРОК, Jira№A2105505-371
