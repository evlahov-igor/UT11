...
Функция ДанныеДляПечатиЦенниковИЭтикеток(Идентификатор, ОбъектыПечати, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Идентификатор = "ЦенникиЭтикетки" Тогда
		Возврат МенеджерОбъекта.КР_ДанныеДляПечатиЭтикетокЦенников(ОбъектыПечати);
	// >> 13.02.2023, Гашников А.П., КРОК, Jira№ A2105505-1028
	КонецЕсли;
...
Функция ДанныеДляПечатиЭтикетокДоставки(Идентификатор, ОбъектыПечати) Экспорт
	...
	Возврат ОбработкаПечатьЭтикетокИЦенников.ДанныеДляПечатиЭтикетокДоставки(ОбъектыПечати);
...
Функция ДанныеДляПечатиЭтикетокУпаковочныеЛисты(ОбъектыПечати) Экспорт
	...
	ОбработкаПечатьЭтикетокИЦенников = ЦенообразованиеВызовСервера.ОбработкаПечатьЭтикетокИЦенников();
	Возврат ОбработкаПечатьЭтикетокИЦенников.ДанныеДляПечатиЭтикетокУпаковочныеЛисты(ОбъектыПечати);
