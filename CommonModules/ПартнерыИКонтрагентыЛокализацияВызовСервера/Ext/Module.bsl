...
Процедура ИзменитьГоловногоКонтрагента(Контрагент, ГоловнойКонтрагент, ОписаниеОшибки) Экспорт
	...
	Если ЗначениеЗаполнено(ИНН) Тогда
		...
		ВыборкаКонтрагент = ПартнерыИКонтрагентыЛокализация.ИННКППУжеИспользуетсяВИнформационнойБазе(ИНН, КПП, Контрагент);
...
Функция ДанныеКонтрагентаПоИНН(ЭтоЮридическоеЛицо, ИНН, ИдентификаторЗадания) Экспорт
	...
	Если ЭтоЮридическоеЛицо Тогда
		...
		ПартнерыИКонтрагентыЛокализация.ПреобразоватьРезыльтатСведенийОЮрЛице(РеквизитыЮридическогоЛица);
...
// 	КППГоловногоКонтрагента - Строка - строка кпп
// Возвращаемое значение:
// 	
...
Процедура ИсторияРеквизитовВСтруктуру(Реквизиты) Экспорт
	...
	Если Реквизиты.Свойство("ИсторияРеквизитов") Тогда
	...
	Если Реквизиты.Свойство("ПрочиеВидыДеятельности") Тогда
		Реквизиты.Удалить("ПрочиеВидыДеятельности");
	КонецЕсли;
