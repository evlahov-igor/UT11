...
Процедура ОбновитьГиперссылкуПробитияФискальногоЧека(ДокументСсылка, Форма, МассивПредставлений) Экспорт
	...
	СписокФискальныхОпераций = МенеджерОборудованияВызовСервера.СписокФискальныхОпераций(ДокументСсылка);
...
Функция ПредметыРасчетовПоДокументу(ДокументСсылка) Экспорт
	...
	|	ЕСТЬNULL(ТабличнаяЧасть.Номенклатура.ОсобенностьУчета, ЗНАЧЕНИЕ(Перечисление.ОсобенностиУчетаНоменклатуры.ПустаяСсылка)) КАК ОсобенностьУчета,
...
//  ЗначенияРеквизитов	 - Структура - см. КорректировкаРеализацииЛокализация.ПараметрыФормированияТранспортныхНакладных().ИменаРеквизитовДляДополнительнойПроверки
	...
	Для Каждого СтрокаТЧ Из Товары Цикл
		...
		Пока КоличествоСтрокМассиваСтрокДанныхДляВидовЗапасов >= ТекущаяСтрока Цикл
			...
			Если СтрокаТЧ.КоличествоУпаковок > СтрокаДанныхДляВидовЗапасов.КоличествоУпаковок Тогда 
				СтрокаТоваровСРаспределениемПоВидовЗапасов.КоличествоУпаковок = СтрокаДанныхДляВидовЗапасов.КоличествоУпаковок;
