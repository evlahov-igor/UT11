...
// Для отправки содержимого в УТ10
	ПрисоединенныйФайлОбъект.ДополнительныеСвойства.Вставить("КР_ДанныеФайла", Контекст.ДанныеФайла);
// >> 03.11.2023 Петухов А.В., Фактор, #3226
...
// << 03.11.2023 Петухов А.В., Фактор, #3226
			...
			Если РеквизитыЗначения.Свойство(КР_УТ10_УТ11_ЗагрузкаДанныхСервер.СвойствоОбъектБылЗагружен()) Тогда
				ФайлОбъект.ДополнительныеСвойства.Вставить(КР_УТ10_УТ11_ЗагрузкаДанныхСервер.СвойствоОбъектБылЗагружен());
			КонецЕсли;
// >> 03.11.2023 Петухов А.В., Фактор, #3226
		КонецЕсли;
...
// << 03.11.2023 Петухов А.В., Фактор, #3226
	// Для исключения обратной отправки
	Если ИнформацияОФайле.Свойство(КР_УТ10_УТ11_ЗагрузкаДанныхСервер.СвойствоОбъектБылЗагружен()) Тогда
		РеквизитыЗначения.Вставить(КР_УТ10_УТ11_ЗагрузкаДанныхСервер.СвойствоОбъектБылЗагружен());
	КонецЕсли;
// >> 03.11.2023 Петухов А.В., Фактор, #3226
