...
Процедура ЗаполнитьПараметрыЭлектронногоДокументаПоОснованию(Основание, Параметры) Экспорт
	...
	Параметры.Вставить("НаправлениеЭД",           Перечисления.НаправленияЭДО.Исходящий);
...
Процедура ОтключитьКонтрольОтраженияВУчетеДокументовПодсистемы(ВидыЭлектронныхДокументов) Экспорт
	...
	ВидыЭлектронныхДокументов.Удалить(ВидыЭлектронныхДокументов.Найти(Перечисления.ТипыДокументовЭДО.ЗапросКоммерческихПредложений));
	ВидыЭлектронныхДокументов.Удалить(ВидыЭлектронныхДокументов.Найти(Перечисления.ТипыДокументовЭДО.КоммерческоеПредложение));
...
//
// Параметры:
//  ТипЭлектронногоДокумента - см. ОбменСКонтрагентами.ТипыДокументов
// Возвращаемое значение:
//  СписокЗначений - список значений, в котором значение = пустая ссылка документа учета, а представление - его представление.
...
Процедура ОбработатьОшибкиФормированияДерева(Ошибки, ВидЭД, СсылкаНаОбъект = Неопределено)
	...
	Если ЗначениеЗаполнено(Ошибки) Тогда
		...
		ЭлектронноеВзаимодействие.ОбработатьОшибку(
			ВидОперации, ПодробноеОписаниеОшибки, ПодробноеОписаниеОшибки,, СсылкаНаОбъект);
	КонецЕсли;
