...
// Контрагент
Процедура ИзменитьКонтрагентаПриглашения(ПолныйКлючПриглашения, Контрагент) Экспорт
...
Процедура ДобавитьОшибкуПустогоКонтрагентаВПриглашении(КонтекстДиагностики, КлючПриглашения) Экспорт
	...
	ОбработкаНеисправностейБЭДКлиентСервер.ДобавитьОшибку(КонтекстДиагностики, Ошибка, Ложь,
		...
		Попытка
			...
			Если Не ЗначениеЗаполнено(МенеджерЗаписи.Контрагент) Тогда
				Если ЗначениеЗаполнено(НовыеПриглашения.ИНН) Тогда
					МенеджерЗаписи.Контрагент = ИнтеграцияЭДО.СсылкаНаОбъектПоИННКПП("Контрагенты", НовыеПриглашения.ИНН, НовыеПриглашения.КПП);
					Если Не ЗначениеЗаполнено(МенеджерЗаписи.Контрагент) И НовыеПриглашения.СтатусУчастника = СтатусПриглашенияПринято Тогда
						СоздатьКонтрагентаБезусловно = ПриглашенияЭДОСлужебный.СоздатьКонтрагентаБезусловно(НовыеПриглашения.ИНН, НовыеПриглашения.КПП);
						Если СоздатьКонтрагентаБезусловно Тогда
