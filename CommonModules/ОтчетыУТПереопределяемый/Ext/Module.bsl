...
Процедура НастроитьПараметрыОтборыПоФункциональнымОпциям(Форма, НовыеНастройкиКД)
	...
	Если ИмяОтчета = "СправкаРасчетПереоценкиВалютныхСредств"
		...
		КолонкиТаблицы = НовыеНастройкиКД.Структура[0].Структура[0].Колонки[0];
		...
		ГруппировкаРаздел = НовыеНастройкиКД.Структура[0].Структура[0].Строки[0];
		...
		ГруппировкаАналитика = НовыеНастройкиКД.Структура[0].Структура[0].Строки[0].Структура[0];
