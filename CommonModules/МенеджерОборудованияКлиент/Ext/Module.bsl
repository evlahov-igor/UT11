...
Процедура ВыполнитьНастройкуОборудования(Идентификатор, ОповещениеПриЗавершении = Неопределено) Экспорт
	...
	ДрайверArtix = ПредопределенноеЗначение("Справочник.ДрайверыОборудования.КР_ДрайверArtix");
	Если ДанныеУстройства.ДрайверОборудования = ДрайверArtix Тогда
		ФормаНастройки = "КР_ФормаНастройкиArtix";
	КонецЕсли;
	// >> 27.01.2023, Гашников А.П., КРОК, Jira№ A2105505-1150
