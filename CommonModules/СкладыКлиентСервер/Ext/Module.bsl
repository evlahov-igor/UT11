...
Процедура СогласоватьЗначенияПризнаков(ОбъектСправочник) Экспорт
	...
	//ОбъектСправочник.ИспользоватьОрдернуюСхемуПриОтгрузке   
	Истина
	// >> 01.11.2022 Марченко С.Н., КРОК, JIRA№A2105505-751
	...
	// << 01.11.2022 Марченко С.Н., КРОК, JIRA№A2105505-751
	// Отключаем типовую проверку если КР_СкладСПомещениямиБезордернойОтгрузки
	//	так как она не согласуется с новой логикой поведения системы
	И Не ОбъектСправочник.КР_СкладСПомещениямиБезордернойОтгрузки  
	// >> 01.11.2022 Марченко С.Н., КРОК, JIRA№A2105505-751   
	 Тогда
	...
	// Отключаем типовую проверку если КР_СкладСПомещениямиБезордернойОтгрузки
	//	так как она не согласуется с новой логикой поведения системы
	Если Не ОбъектСправочник.КР_СкладСПомещениямиБезордернойОтгрузки Тогда 
	// >> 01.11.2022 Марченко С.Н., КРОК, JIRA№A2105505-751   
	...
	Если Не (ОбъектСправочник.ИспользоватьОрдернуюСхемуПриОтгрузке
		...
		И Не ОбъектСправочник.КР_АдресныйСкладБезордернойОтгрузки 
		// >> 28.10.2022 Марченко С.Н., КРОК, JIRA№A2105505-751
