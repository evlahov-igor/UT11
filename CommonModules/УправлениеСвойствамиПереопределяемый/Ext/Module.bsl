...
Процедура ПриПолученииПредопределенныхНаборовСвойств(Наборы) Экспорт
	...
	// << 06.04.2023 Федотов А.М., КРОК, Jira№[A2105505-1465]
	Набор = Наборы.Строки.Добавить();
	Набор.Имя = "Документ_ТранспортнаяНакладная";
	Набор.Идентификатор = Новый УникальныйИдентификатор("02a89b5d-93b6-4680-9780-8a0de2634d78");	
	// >> 06.04.2023 Федотов А.М., КРОК, Jira№[A2105505-1465]
