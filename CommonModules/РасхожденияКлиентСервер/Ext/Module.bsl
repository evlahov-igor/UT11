...
Процедура УправлениеДоступностью(Форма) Экспорт
	...
	Иначе
		...
		Если ТипОснованияПеремещениеТоваров(Форма.Объект.Ссылка)
			...
			НадписьОформитьДокументы.Заголовок = НСтр("ru = 'Оформление документов доступно при указанном способе отражения и наличии расхождений в статусах ""Отрабатывается"" и ""Отработано""'");
