...
Функция ТекстЗапросаРегистрСведенийЦеныНоменклатурыУсловиеСоединения(ИсточникТоваров,
	...
	Если ИсточникВидовЦен <> Неопределено Тогда
		...
		ТекстыЗапросов.Добавить(" = &ИсточникЦен.ВидЦены И");
	КонецЕсли;
...
Функция ТекстПолейДляЦенообразования(Настройки, 
	...
	Если ЗначениеЗаполнено(Настройки.ПолеХарактеристика) Тогда
		ТекстПоля =	"ВЫБОР
						...
						|	ИНАЧЕ " + Настройки.ИсточникТоваров + "." + Настройки.ПолеХарактеристика + ".ХарактеристикаНоменклатурыДляЦенообразования
						|КОНЕЦ";
	Иначе
	...
	Если ЗначениеЗаполнено(Настройки.ПолеСерия) Тогда
		ТекстПоля =	"ВЫБОР
						...
						|	ИНАЧЕ "+ Настройки.ИсточникТоваров + "." + Настройки.ПолеСерия + ".СерияНоменклатурыДляЦенообразования
						|КОНЕЦ";
	Иначе
