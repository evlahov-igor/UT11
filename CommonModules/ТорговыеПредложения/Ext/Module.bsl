...
//   * СкидкиТорговыхПредложений             - ТаблицаЗначений - настройки варианта публикации скидок "ВидыСкидок".
//     * ВидСкидки                           - ОпределяемыйТип.ВидыСкидок - ссылка на скидку.
//     * Количество                          - Число - количество от, при котором будет действовать скидка.
//   * СкидкиТорговыхПредложенийВидыЦен      - ТаблицаЗначений - настройки варианта публикации скидок "ВидыЦен".
//     * ВидыЦен                             - ОпределяемыйТип.ВидыЦен - ссылка на вид цены.
//     * Количество                          - Число - количество от, при котором будет действовать скидка.
...
Функция НастройкиПубликации(ТорговоеПредложение) Экспорт
	...
	|ГДЕ
	|	СкидкиТорговыхПредложений.ТорговоеПредложение = &Ссылка
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|ГДЕ
	|	СкидкиТорговыхПредложенийВидыЦен.ТорговоеПредложение = &Ссылка";
	...
	СкидкиТорговыхПредложений = РезультатыЗапроса[1];
	Если Не СкидкиТорговыхПредложений.Пустой() Тогда
		Результат.Вставить("СкидкиТорговыхПредложений", СкидкиТорговыхПредложений.Выгрузить());
	КонецЕсли;
	
	СкидкиТорговыхПредложенийВидыЦен = РезультатыЗапроса[2];
	Если Не СкидкиТорговыхПредложенийВидыЦен.Пустой() Тогда
		Результат.Вставить("СкидкиТорговыхПредложенийВидыЦен", СкидкиТорговыхПредложенийВидыЦен.Выгрузить());
	КонецЕсли;
