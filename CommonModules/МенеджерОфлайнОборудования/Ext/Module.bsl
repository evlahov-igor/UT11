...
Функция ПолучитьЗаписьТовара() Экспорт
	...
	ЗаписьТовара.Вставить("КР_НаименованиеНаЦеннике", "");
	ЗаписьТовара.Вставить("КР_ЦветКод", "");
	ЗаписьТовара.Вставить("КР_ОсобенностьУчета", "");
	// >> 30.01.2023, Гашников А.П., КРОК, Jira№ A2105505-1150
	
	ЗаписьТовара.Вставить("КР_Модель", "");		// #4641.. Фомин Д.Ю. 03.09.2024.	
...
Функция ПолучитьЗаписьХарактеристики() Экспорт
	...
	// Строка, необязательное
	ЗаписьХарактеристики.Вставить("злGTIN");
	// ..#3967
	...
	// << 30.01.2023, Гашников А.П., КРОК, Jira№ A2105505-1150
	ЗаписьХарактеристики.Вставить("КР_Маркируется", Ложь);
	// >> 30.01.2023, Гашников А.П., КРОК, Jira№ A2105505-1150
