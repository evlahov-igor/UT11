...
#Область Установить_ИспользоватьВвозТоваровИзТаможенногоСоюза

	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = "УчетНДСРФ.Установить_ИспользоватьВвозТоваровИзТаможенногоСоюза";
	Обработчик.Версия = "2.5.3.28";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("279d93dd-bcb7-49d6-8bee-7a02f4c49ca0");
	Обработчик.Комментарий = НСтр("ru = 'Установка константу ИспользоватьВвозТоваровИзТаможенногоСоюза'");
	
	Читаемые = Новый Массив;
	Читаемые.Добавить(Метаданные.Константы.ИспользоватьВвозТоваровИзТаможенногоСоюза.ПолноеИмя());
	Читаемые.Добавить(Метаданные.Константы.ИспользоватьИмпортныеЗакупки.ПолноеИмя());
	Обработчик.ЧитаемыеОбъекты = СтрСоединить(Читаемые, ",");
	
	Изменяемые = Новый Массив;
	Изменяемые.Добавить(Метаданные.Константы.ИспользоватьВвозТоваровИзТаможенногоСоюза.ПолноеИмя());
	Обработчик.ИзменяемыеОбъекты = СтрСоединить(Изменяемые, ",");

#КонецОбласти

#Область Установить_ИспользоватьВвозТоваровИзТаможенногоСоюзаТоварыВПути

	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = "УчетНДСРФ.Установить_ИспользоватьВвозТоваровИзТаможенногоСоюзаТоварыВПути";
	Обработчик.Версия = "2.5.3.28";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("61660629-28b1-420d-b381-84551c374881");
	Обработчик.Комментарий = НСтр("ru = 'Установка константу ИспользоватьВвозТоваровИзТаможенногоСоюзаТоварыВПути'");
	
	Читаемые = Новый Массив;
	Читаемые.Добавить(Метаданные.Константы.ИспользоватьВвозТоваровИзТаможенногоСоюзаТоварыВПути.ПолноеИмя());
	Читаемые.Добавить(Метаданные.Константы.ИспользоватьИмпортныеЗакупки.ПолноеИмя());
	Обработчик.ЧитаемыеОбъекты = СтрСоединить(Читаемые, ",");
	
	Изменяемые = Новый Массив;
	Изменяемые.Добавить(Метаданные.Константы.ИспользоватьВвозТоваровИзТаможенногоСоюзаТоварыВПути.ПолноеИмя());
	Обработчик.ИзменяемыеОбъекты = СтрСоединить(Изменяемые, ",");

#КонецОбласти

#Область Установить_ИспользоватьПродажиНаЭкспорт

	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = "УчетНДСРФ.Установить_ИспользоватьПродажиНаЭкспорт";
	Обработчик.Версия = "2.5.3.28";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("de5641db-73b3-4d0f-97c5-d5ffb7eafcb7");
	Обработчик.Комментарий = НСтр("ru = 'Установка константу ИспользоватьПродажиНаЭкспорт'");
	
	Читаемые = Новый Массив;
	Читаемые.Добавить(Метаданные.Константы.ИспользоватьПродажиНаЭкспортНесырьевыхТоваров.ПолноеИмя());
	Читаемые.Добавить(Метаданные.Константы.ИспользоватьПродажиНаЭкспортСырьевыхТоваровУслуг.ПолноеИмя());
	Обработчик.ЧитаемыеОбъекты = СтрСоединить(Читаемые, ",");
	
	Изменяемые = Новый Массив;
	Изменяемые.Добавить(Метаданные.Константы.ИспользоватьПродажиНаЭкспортНесырьевыхТоваров.ПолноеИмя());
	Обработчик.ИзменяемыеОбъекты = СтрСоединить(Изменяемые, ",");
...
#Область Установить_ИспользоватьРазделыТаможеннойДекларацииИмпорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = "УчетНДСРФ.Установить_ИспользоватьРазделыТаможеннойДекларацииИмпорт";
	Обработчик.Версия = "2.5.7.35";
	Обработчик.РежимВыполнения = "Монопольно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("e3878f93-3cef-403b-872c-41276496577c");
	Обработчик.Комментарий = НСтр("ru = 'Установка константу ИспользоватьРазделыТаможеннойДекларацииИмпорт'");
...
Функция СчетаФактурыВыданныеНаОсновании(ПараметрыРегистрации) Экспорт
	...
	Если ТипЗнч(ПараметрыРегистрации.Контрагент) = Тип("СправочникСсылка.Контрагенты")
		И ПараметрыРегистрации.Контрагент.ЮрФизЛицо = Перечисления.ЮрФизЛицо.ФизЛицо Тогда
...
Функция СчетаФактурыКомиссионеруНаОсновании(ПараметрыРегистрации) Экспорт
	...
	ИначеЕсли ЗначениеЗаполнено(ПараметрыРегистрации.Ссылка) Тогда
		...
		Если ПараметрыРегистрации.РеализацияЧерезКомиссионера Тогда
			ТаблицаСчетаФактуры = Документы.СчетФактураВыданный.СчетаФактурыПоОснованию(ПараметрыРегистрации.Ссылка);
		Иначе
...
Процедура ПолучитьПартии(ПараметрыРасчета) Экспорт
	...
	|		ВЫБОР КОГДА Партии.Регистратор ССЫЛКА Документ.РаспределениеПрочихЗатрат
	|			ТОГДА Партии.КорНаправлениеДеятельности
	|			ИНАЧЕ Партии.НаправлениеДеятельности
	|		КОНЕЦ КАК НаправлениеДеятельности,
	|		ВЫБОР КОГДА Партии.Регистратор ССЫЛКА Документ.РаспределениеПрочихЗатрат
	|			ТОГДА Партии.НаправлениеДеятельности
	|			ИНАЧЕ Партии.КорНаправлениеДеятельности
	|		КОНЕЦ КАК КорНаправлениеДеятельности,
	|		НЕОПРЕДЕЛЕНО,
	|		Партии.СтатьяСписанияНДС,
	|		Партии.АналитикаСписанияНДС,
...
Процедура ПолучитьБлокировкиНДС(ПараметрыРасчета) Экспорт
	...
	|			ТОГДА 0
	|			ИНАЧЕ ВЫРАЗИТЬ(ОплаченныеЭлектронныеУслуги.НДСПриобретения * ((ОплаченныеЭлектронныеУслуги.СуммаПриобретения - ОплаченныеЭлектронныеУслуги.СуммаОплаты) / ОплаченныеЭлектронныеУслуги.СуммаПриобретения) КАК ЧИСЛО(31, 2))
	|		КОНЕЦ
	|	ИЗ
	...
	Пока НачалоПериода <= ПараметрыРасчета.КонецПериода Цикл
		...
		Попытка
			Если НачалоПериода = ПараметрыРасчета.НачалоПериода Тогда
				Документы.СводнаяСправкаНДС.СформироватьСводныеСправкиНДС(ПараметрыРасчета.МассивОрганизаций, НачалоПериода);
			Иначе
...
Процедура Установить_ИспользоватьРазделыТаможеннойДекларацииИмпорт() Экспорт
...
Процедура Установить_ИспользоватьВвозТоваровИзТаможенногоСоюза() Экспорт
	
	МенеджерЗначения = Константы.ИспользоватьВвозТоваровИзТаможенногоСоюза.СоздатьМенеджерЗначения();
	МенеджерЗначения.Значение = Константы.ИспользоватьИмпортныеЗакупки.Получить();
...
Процедура Установить_ИспользоватьВвозТоваровИзТаможенногоСоюзаТоварыВПути() Экспорт
	
	МенеджерЗначения = Константы.ИспользоватьВвозТоваровИзТаможенногоСоюзаТоварыВПути.СоздатьМенеджерЗначения();
	МенеджерЗначения.Значение = Константы.ИспользоватьИмпортныеЗакупкиТоваровВПути.Получить();
...
Процедура Установить_ИспользоватьПродажиНаЭкспорт() Экспорт
	
	МенеджерЗначения = Константы.ИспользоватьПродажиНаЭкспорт.СоздатьМенеджерЗначения();
	МенеджерЗначения.Значение = 
		Константы.ИспользоватьПродажиНаЭкспортНесырьевыхТоваров.Получить()
...
Функция РассчитатьНДСЗаписиКнигиПокупокСторно(ПараметрыРасчета)
	...
	|			ТОГДА НДСЗаписиКнигиПокупокОтборСторно.ДатаИсправляемогоДокумента
...
Функция РассчитатьНДСЗаписиКнигиПокупокПоАвансуВыданному(ПараметрыРасчета)
	...
	|	НДСАвансыВыданныеЗачеты.Контрагент                                   КАК Поставщик,
...
Функция РассчитатьНДСЗаписиКнигиПродажСторно(ПараметрыРасчета)
	...
	|			ТОГДА НДСЗаписиКнигиПродажОтборСторно.ДатаИсправляемогоДокумента
...
Функция РассчитатьНДСЗаписиКнигиПродажПоАвансуВыданному(ПараметрыРасчета)
	...
	|		НДСАвансыВыданныеЗачеты.Организация = СчетаФактурыПолученныеАванс.Организация
	|		И НДСАвансыВыданныеЗачеты.ДокументОплаты = СчетаФактурыПолученныеАванс.ДокументОплаты
	|		И НДСАвансыВыданныеЗачеты.Контрагент = СчетаФактурыПолученныеАванс.Контрагент
	|	
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	|		ИсправленныеСчетаФактурыПолученныеАванс КАК ИсправленныеСчетаФактурыПолученныеАванс
	|	ПО
	|		НДСАвансыВыданныеЗачеты.Организация = ИсправленныеСчетаФактурыПолученныеАванс.Организация
	|		И НДСАвансыВыданныеЗачеты.ДокументОплаты = ИсправленныеСчетаФактурыПолученныеАванс.ДокументОплаты
	|		И НДСАвансыВыданныеЗачеты.Контрагент = ИсправленныеСчетаФактурыПолученныеАванс.Контрагент
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	|		РегистрСведений.ДанныеПервичныхДокументов КАК РеквизитыДокументаОплаты
	|	ПО
