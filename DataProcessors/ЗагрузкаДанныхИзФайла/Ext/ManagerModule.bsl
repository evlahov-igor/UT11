...
Функция ДокументПоПредставлению(Представление, Типы)
	...
	Для каждого Тип Из Типы Цикл
		...
		Если ОбъектМетаданных = Метаданные.Документы.УпаковочныйЛист Тогда
			Документ = Документы[ОбъектМетаданных.Имя].НайтиПоКоду(НомерДокумент, ДатаДокумента);
		Иначе
		// >> 22.05.2023, Маскаев П.Ю., КРОК, Jira№ A2105505-1098
		Документ = Документы[ОбъектМетаданных.Имя].НайтиПоНомеру(НомерДокумент, ДатаДокумента); // ОбъектМетаданныхДокумент
		КонецЕсли; // << 22.05.2023, Маскаев П.Ю., КРОК, Jira№ A2105505-1098
