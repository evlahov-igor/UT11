...
//			врУстановитьЗначениеКонст(Истина, ДатаПереходаНаЦенообразование25);
		КонецЕсли;
...
Функция ПолучитьВидыЦенСОшибками()
	...
	Для Каждого Строка Из СостояниеПерехода.ПараметрыШага3.ТаблицаДляОбработки Цикл
