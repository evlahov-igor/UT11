...
Процедура СостояниеВыполнения(Команда)
	...
	Для Каждого ВыделеннаяСтрока Из ВыделенныеСтроки Цикл
		...
		Если ТипВыделенногоДокумента = Тип("ДокументСсылка.ВозвратТоваровОтКлиента") Тогда
			ПоказатьПредупреждение( , НСтр("ru = 'Команда не может быть выполнена для документов """ + ТипВыделенногоДокумента + """.';
												|en = 'Command cannot be executed for documents """ + ТипВыделенногоДокумента + """.' "));
			Возврат;
		КонецЕсли;
