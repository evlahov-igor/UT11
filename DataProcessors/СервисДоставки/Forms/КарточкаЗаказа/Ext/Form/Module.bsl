...
Процедура ЗаполнитьСписокВыбораКонтактноеЛицоТелефонСервер(ВидРоли)
	...
	Если ЗначениеЗаполнено(КонтактнаяИнформация) Тогда
		...
		Для Каждого СтрокаКИ Из КонтактнаяИнформация Цикл
			...
			ВидТелефона = СтрокаКИ.Вид.Наименование;
...
Процедура УстановитьВидимостьДоступность();
	...
	Если РежимМастера < СервисДоставкиКлиентСервер.РежимМастераЗарегистрирован() Тогда
		...
		Элементы.ИзменитьРеквизитыЗаказаГруппаМеню.Видимость = Ложь;
	...
	Иначе
		...
		Элементы.ИзменитьРеквизитыЗаказаГруппаМеню.Видимость = Истина;
...
Процедура СформироватьЗаголовокФормы()
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ТекстЗаголовка, ЗаказНаДоставкуПредставление);
