...
&НаКлиенте
Процедура Константа_ИспользоватьМЧДПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
КонецПроцедуры
...
Процедура ОповещатьОСобытияхЭДОПриИзменении(Элемент)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		"ВключитьДиалог", "Видимость", РазделениеВключено И Не Обсуждения И ОповещатьОСобытияхЭДО
		И ТребуетсяВзаимодействие);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		"ВключитеДиалог", "Видимость", РазделениеВключено И Не Обсуждения И ОповещатьОСобытияхЭДО
...
Процедура ПрочитатьУстановитьДоступность(РеквизитПутьКДанным = "")
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		"ГруппаНастройкиОбменаЕИС", "Видимость", ЕстьОбменСЕИСДляПоставщиков И ЕстьОбменСЕИСДляЗаказчиков);
	...
	Если ЕстьОбменСКонтрагентами
		...
		Константа_ИспользоватьМЧД = Константы["ИспользоватьМЧД"].Получить();
