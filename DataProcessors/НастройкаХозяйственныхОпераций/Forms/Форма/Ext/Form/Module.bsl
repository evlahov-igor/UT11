...
Процедура ДобавитьКодЭлемента(Родитель, ТабличныеЧасти, Отступ = "	")
	...
	Для Каждого Элемент Из Родитель.Строки Цикл
		...
		Если Элемент.ЭтоГруппа Тогда
			...
			КонецЕсли;
			Код1С.ДобавитьСтроку(СтрШаблон("%1МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, ""Наименование"", ""ru = '%2'"", КодыЯзыков); // @НСтр-2" + Символы.ПС, Отступ, Элемент.Наименование));
		...
		Код1С.ДобавитьСтроку(СтрШаблон("%1МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, ""Наименование"", ""ru = '%2'"", КодыЯзыков); // @НСтр-2", Отступ, НаименованиеЭлемента));
