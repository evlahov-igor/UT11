...
Процедура ПодписатьИОтправить(Команда)
	...
	Иначе
		ПараметрыДокументов = ПараметрыФормированияДокументов(ЭтотОбъект, СписокДокументов);
		МассивОбъектовУчета = Новый Массив(СписокДокументов);
	КонецЕсли;
	...
	ОбъектДопДанных = СписокДокументов[0];	
