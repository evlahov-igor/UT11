...
Функция ПотребностиИДоступныеОстатки(Отборы)
	...
	ТекстЗапроса =
		...
		|УПОРЯДОЧИТЬ ПО
		|	Номенклатура, Характеристика, Назначение, Склад, ДатаДоступности";
	...
	Если Отборы.Свойство("СкладОтправитель") Тогда
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&Склад", "РаспределениеЗапасов.Склад = &СкладОтправитель");
	...
	ТекстЗапроса =
		...
		|УПОРЯДОЧИТЬ ПО
		|	Номенклатура, Характеристика, Назначение, Склад, ЖелаемаяДатаОтгрузки";
