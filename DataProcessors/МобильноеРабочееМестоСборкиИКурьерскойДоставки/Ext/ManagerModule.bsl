...
Функция ДоступнаЯндексКасса(Распоряжение) Экспорт
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьИнтеграциюСЯндексКассой") Тогда
		Возврат Ложь;
	КонецЕсли;
	...
	УстановитьПривилегированныйРежим(Истина);
	Результат = Справочники.НастройкиЯндексКассы.НайтиНастройку(КлючиПоиска, Истина) 
		<> Справочники.НастройкиЯндексКассы.ПустаяСсылка();
