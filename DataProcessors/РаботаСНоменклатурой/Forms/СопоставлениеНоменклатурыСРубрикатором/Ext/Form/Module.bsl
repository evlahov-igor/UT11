...
Процедура ЗавершитьНастройкуФормыВРежимеВыгрузки()
	...
	Если ЭтоВыгрузкаВНациональныйКаталог Тогда
		...
		Элементы.ИнформацияРеквизиты.Заголовок = СтроковыеФункции.ФорматированнаяСтрока(Шаблон, НСтр(
			"ru='Жирным шрифтом'"), НСтр("ru=' выделены обязательные для заполнения реквизиты.'"), НСтр(
			"ru='Красным'"), НСтр(
		"ru=' дополнительно отмечены не сопоставленные обязательные реквизиты.'"));
	Иначе
