...
Процедура УстановитьВидимость()
	...
	ЕстьДоступКИзменнению = ПравоДоступа("Изменение", Метаданные.Документы.ПоступлениеБезналичныхДенежныхСредств)
	...
	Элементы.СписокИзменить.Видимость = ЕстьДоступКИзменнению;
	...
	Элементы.СписокОтметитьПроведениеБанком.Видимость = ЕстьДоступКИзменнению;
