...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "" Тогда
		...
		СинхронизацияДанных = ОбщиеСведенияОНастроенныхОбменах.ОбменED ИЛИ ОбщиеСведенияОНастроенныхОбменах.ОбменXML;
		...
		Элементы.ИспользоватьИсправлениеДокументов.Доступность = 
			...
			И НЕ СинхронизацияДанных;
		
		Элементы.ГруппаКомментарийИспользоватьИсправлениеДокументовСинхронизацияДанных.Видимость = СинхронизацияДанных;
