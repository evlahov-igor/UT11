...
Процедура ДекорацияКоэффициентРасширеннаяПодсказкаОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если НавигационнаяСсылкаФорматированнойСтроки = "ИзменитьПлановоеКоличествоПотребительскихУпаковокПоGTIN" Тогда
		...
		ПараметрыФормыУточнения.Вставить("ДоступноРедактированиеВидаУпаковки", Истина);
...
Процедура УстановитьПоляПредставленияСтроки(Форма, ТекущиеДанные)
	...
	СкрыватьЭлементыПриОтсутствииДанных.Вставить(Элементы.ДекорацияНанесен,           (ЭтоТабак Или ЭтоАльтернативныйТабак Или ЭтоНСП Или ЭтоУпакованнаяВода Или ЭтоМолочнаяПродукция));
	...
	Если ЭтоТабак Или ЭтоАльтернативныйТабак Или ЭтоНСП Или ЭтоМолочнаяПродукция Или ЭтоУпакованнаяВода Тогда
