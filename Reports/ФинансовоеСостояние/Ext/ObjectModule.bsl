...
Функция ТекстЗапросаДинамикаОборотныхСредств()
	...
	|ИЗ
	|	РегистрСведений.ОтносительныеКурсыВалют.СрезПоследних({&КонецПериода}, БазоваяВалюта = &БазоваяВалютаПоУмолчанию) КАК КурсВалюты
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	|		РегистрСведений.ОтносительныеКурсыВалют.СрезПоследних({&КонецПериода}, 
	|			Валюта = &ВалютаОтчета И БазоваяВалюта = &БазоваяВалютаПоУмолчанию
