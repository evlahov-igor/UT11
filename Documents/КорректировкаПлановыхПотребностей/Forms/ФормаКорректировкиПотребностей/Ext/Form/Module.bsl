...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Корректировка) Тогда
		...
		ТабличнаяЧастьУменьшениеПотребностей = Корректировка.УменьшениеПотребностей;
		ККорректировке = ТабличнаяЧастьУменьшениеПотребностей[0].Количество;
		
		ТабличнаяЧастьУвеличениеПотребностей = Корректировка.УвеличениеПотребностей;
	...
	//Иначе
	//	
	//	НоменклатураКорректировка = Справочники.Номенклатура.НайтиПоНаименованию("Продукция на замену", Истина);
	//	
	КонецЕсли;
