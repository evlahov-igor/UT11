...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(Помещение) Тогда 
		...
		СвязиПараметровВыбора = Новый Массив(Элементы.Ячейка.СвязиПараметровВыбора); 
		Для Итератор = -СвязиПараметровВыбора.ВГраница() По 0 Цикл 
			...
			КонецЕсли;
		КонецЦикла;	
		Элементы.Ячейка.СвязиПараметровВыбора = Новый ФиксированныйМассив(СвязиПараметровВыбора);	
