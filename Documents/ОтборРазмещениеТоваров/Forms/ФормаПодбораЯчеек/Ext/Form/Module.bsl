...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(Помещение) Тогда 
		...
		СвязиПараметровВыбора = Новый Массив(Элементы.ЯчейкиЯчейка.СвязиПараметровВыбора); 
		Для Итератор = -СвязиПараметровВыбора.ВГраница() По 0 Цикл 
			ЗначениеСвязи = СвязиПараметровВыбора[-Итератор];
			Если ЗначениеСвязи.ПутьКДанным = "Помещение" Тогда     
				СвязиПараметровВыбора.Удалить(-Итератор);
				Прервать;
			КонецЕсли;
		КонецЦикла;	
		Элементы.ЯчейкиЯчейка.СвязиПараметровВыбора = Новый ФиксированныйМассив(СвязиПараметровВыбора);	
