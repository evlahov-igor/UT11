...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|		И ВыкупВозвратнойТарыУПоставщика.Проведен И НЕ ВыкупВозвратнойТарыУПоставщика.ПредусмотренЗалогЗаТару)
	|	ИЛИ НЕ ВыкупВозвратнойТарыУПоставщика.Проведен И (ИСТИНА В
	|			(ВЫБРАТЬ ПЕРВЫЕ 1
	|			ИСТИНА
	|			ИЗ
	|				Документ.ВыкупВозвратнойТарыУПоставщика.РасшифровкаПлатежа КАК ТЧРасшифровкаПлатежа
