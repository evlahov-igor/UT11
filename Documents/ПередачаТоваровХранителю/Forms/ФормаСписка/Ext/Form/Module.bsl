...
Процедура ЗаполнитьЗаголовокПоФункциональнойОпции()
	...
	ТекстЗаголовка = ?(ИспользоватьПередачуНаОтветственноеХранениеСПравомПродажи, НСтр("ru = 'хранителям'"), "")
		+ ?(ИспользоватьКомиссиюПриПродажах И ИспользоватьПередачуНаОтветственноеХранениеСПравомПродажи, НСтр("ru = '/'"), "")
		+ ?(ИспользоватьКомиссиюПриПродажах, НСтр("ru = 'комиссионерам'"), "");
	
	Заголовок = СтрШаблон(НСтр("ru = 'Передачи товаров %1'"),ТекстЗаголовка);
