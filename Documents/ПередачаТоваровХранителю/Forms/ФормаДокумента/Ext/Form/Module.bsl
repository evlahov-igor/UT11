...
Процедура ТоварыНоменклатураПриИзмененииВопросПользователюЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ДобавитьВСтруктуруДействияЗаполненияЦен(СтруктураДействий, Объект, ИспользоватьСоглашенияСКлиентами, ИспользуетсяЦенообразование25);
...
Процедура ОбработатьШтрихкоды(ДанныеШтрихкодов)
	...
	ДобавитьВСтруктуруДействияЗаполненияЦен(СтруктураДействийСДобавленнымиСтроками, Объект,
		ИспользоватьСоглашенияСКлиентами, ИспользуетсяЦенообразование25);
...
Процедура ЗаполнитьМногооборотнуюТаруИзХранилищаСервер(АдресТарыВХранилище)
	...
	ДобавитьВСтруктуруДействияЗаполненияЦен(СтруктураДействийДобавленныеСтроки, Объект, ИспользоватьСоглашенияСКлиентами, ИспользуетсяЦенообразование25);
	НаправленияДеятельностиКлиентСервер.СтруктураДействийВставитьПриДобавленииСтроки(ЭтаФорма,
...
Процедура УстановитьВидимостьКомандыЗаполненияВидаЦенПоДоговору()
	...
	Элементы.ТоварыЗаполнитьЦеныПоДоговору.Видимость = КомиссионныеПродажи25;
	Элементы.ТоварыЗаполнитьЦеныПоСоглашению.Видимость = Не КомиссионныеПродажи25;
...
Процедура ЗаполнитьЦеныПоДоговоруВСтроке(ПоВсемСтрокам = Ложь)
	...
	Если ЦеныПредприятияЗаполнениеКлиент.НеобходимоЗаполнениеЦенПоВиду(Объект, ВидЦеныДоговора) Тогда
		...
		ЦеныРассчитаны = ЗаполнитьЦеныПоСоглашениюСервер(ПоВсемСтрокам);
		ПродажиКлиент.ОповеститьОбОкончанииЗаполненияЦенПоСоглашению(ЦеныРассчитаны);
...
Процедура КР_ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КР_МетодыМодификацииФорм.ДобавитьЭлементФормыКоличествоТоварыИтого(ЭтотОбъект,
		Элементы.ГруппаИтого, Элементы.СуммаВсего);
