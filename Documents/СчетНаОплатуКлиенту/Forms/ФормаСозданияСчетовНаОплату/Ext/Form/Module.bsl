...
Процедура ОбновитьСервер()
	...
	Иначе
		...
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "ТекстЗапросаДокумент.ЭтапыГрафикаОплаты КАК ЭтапыГрафикаОплаты", ТекстЗапросаДокумент + ".ЭтапыГрафикаОплаты КАК ЭтапыГрафикаОплаты");
