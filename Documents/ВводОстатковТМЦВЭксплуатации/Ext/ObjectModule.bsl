...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ПараметрыРеквизитовОбъекта = 
		ТМЦВЭксплуатацииКлиентСервер.ЗначенияСвойствЗависимыхРеквизитов_ВводОстатковТМЦВЭксплуатации(ЭтотОбъект);
...
Процедура ПроверкаЗаполненияДокумента(НепроверяемыеРеквизиты, Отказ)
	...
	ПроверитьТМЦВЭксплуатации(НепроверяемыеРеквизиты, Отказ);
...
Процедура ПроверитьТМЦВЭксплуатации(НепроверяемыеРеквизиты, Отказ)
