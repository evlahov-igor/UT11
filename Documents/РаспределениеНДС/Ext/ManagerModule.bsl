...
Функция НеобходимоРаспределениеНДСПоТоварам(Организация, Знач Период) Экспорт
	...
	НастройкиУчетаНДС = НастройкиНалоговУчетныхПолитикПовтИсп.ДействующиеПараметрыНалоговУчетныхПолитик("НастройкиУчетаНДС", Организация, Период);
...
Функция СформироватьДвижения(Реквизиты, Регистры, ДопПараметры)
	...
	ТаблицыДляДвижений.Вставить("Таблица" + "ПартииНДСКРаспределению", ТаблицаПартииНДСКРаспределению(РезультатРаспределения, Реквизиты));
	ТаблицыДляДвижений.Вставить("Таблица" + "ПрочиеРасходы", ТаблицаПрочиеРасходы(РезультатРаспределения, Реквизиты));
...
Функция ПолучитьБазуРаспределения(Дата, НачалоПериода, Организация, ДополнительныеПараметрыПолученияВыручки = Неопределено) Экспорт
