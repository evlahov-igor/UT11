...
Процедура РаспределитьРасходы()
	...
	КонецЕсли;
	Если День(КонецМесяца(ДатаОкончанияСписания)) = 29 Тогда
	...
	Для Счетчик = 0 По ВсегоМесяцев Цикл
		...
		Если ЗначениеЗаполнено(СтатьяРасходовРаспределение) Тогда
			...
			Если ЗначениеЗаполнено(Объект.СтатьяРасходов) И Не ЗначениеЗаполнено(АналитикаРасходовРаспределение) Тогда
