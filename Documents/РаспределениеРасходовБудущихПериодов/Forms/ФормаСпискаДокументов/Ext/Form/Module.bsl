...
Процедура СоздатьРаспределениеРасходов(Команда)
	...
	Если Строка <> Неопределено Тогда
		...
		Если СостояниеРаспределения = Неопределено Тогда
			...
			ОбщегоНазначенияСлужебныйКлиентСервер.СообщитьПользователю(ТекстОшибки, ЭтотОбъект, "РасходыКРаспределению");
		КонецЕсли;
...
Процедура ОткрытьКарточкуРасхода(Команда)
	...
	ПараметрыФормыРасшифровки.Вставить("Периодичность", "Месяц");
