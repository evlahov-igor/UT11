...
Функция ТекстЗапросаВтДетализацияПартийСуммы(Запрос, ТекстыЗапроса)
	...
	|	ТаблицаДетализацияПартий.ИдентификаторСтроки  КАК ИдентификаторСтроки,
	|	ТаблицаДетализацияПартий.СтатьяРасходов  	  КАК СтатьяРасходов,
	|	МАКСИМУМ(ТаблицаДетализацияПартий.ДокументПоступления) КАК ДокументПоступления,
...
Функция ТекстЗапросаТаблицаСебестоимостьТоваров(Запрос, ТекстыЗапроса, Регистры) Экспорт
	...
	|		ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковМатериаловПереданныхПереработчикам2_5)
	|		)
	|	И (ТаблицаТовары.РезервПодОбесценениеРегл <> 0 ИЛИ ТаблицаТовары.РезервПодОбесценениеУпр <> 0)
	|	И &ОтражатьСебестоимость
	|
	|УПОРЯДОЧИТЬ ПО
	|	НомерСтроки";
...
Функция ТекстЗапросаТаблицаДвиженияСерийТоваров(Запрос, ТекстыЗапроса, Регистры)
	...
	|		КОГДА &ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковМатериаловПереданныхВПроизводство)
	|			ТОГДА &Подразделение
	|		КОГДА &ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковМатериаловПереданныхПереработчикам2_5)
	|			ТОГДА &Партнер
	|		ИНАЧЕ &Склад 
