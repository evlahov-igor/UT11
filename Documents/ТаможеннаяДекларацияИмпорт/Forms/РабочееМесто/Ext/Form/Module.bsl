...
Функция СформироватьОснованиеДляДекларации(ТекущаяСтрокаКОформлению)
	...
	|	И НЕ ВТОстатки.АналитикаУчетаНоменклатуры.МестоХранения ССЫЛКА Справочник.Склады
	|СГРУППИРОВАТЬ ПО
	...
	|	ЛОЖЬ,
	|	Товары.ДокументПоступления.ЗакупкаПодДеятельность,
	|	Товары.ДокументПоступления.ХозяйственнаяОперация,
