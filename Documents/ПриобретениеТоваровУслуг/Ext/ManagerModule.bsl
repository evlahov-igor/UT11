...
Процедура ЗарегистрироватьУчетныеМеханизмы(МеханизмыДокумента) Экспорт
	...
	МеханизмыДокумента.Добавить("КР_ВесНеттоТовара");
	// >> 14.11.2022 Маскаев П.Ю., КРОК, JIRA№ A2105505-742
...
Функция ДанныеДокументаДляПроведения(Документ, Регистры, ДопПараметры = Неопределено) Экспорт
	...
	Если Не ДопПараметры.ПолучитьТекстыЗапроса Тогда
		...
		// << 14.11.2022 Маскаев П.Ю., КРОК, JIRA№ A2105505-742
		КР_ТекстЗапросаТаблицаТоварыВесНетто(Запрос, ТекстыЗапроса, Регистры);
		// >> 14.11.2022 Маскаев П.Ю., КРОК, JIRA№ A2105505-742
...
// << 14.11.2022 Маскаев П.Ю., КРОК, JIRA№ A2105505-742
Функция КР_ТекстЗапросаТаблицаТоварыВесНетто(Запрос, ТекстыЗапроса, Регистры)
	
	ИмяРегистра = "КР_ВесНеттоТовара";
	...
	ТекстЗапроса =
	"ВЫБРАТЬ
	|	ТаблицаДокумента.Дата КАК ДатаЗаписи,
	...
	|			ТОГДА 0
	|		ИНАЧЕ СУММА(ТаблицаТовары.КР_ВесНетто) / СУММА(ТаблицаТовары.Количество)
	|	КОНЕЦ КАК ВесНетто
	|ИЗ
	|	Документ.ПриобретениеТоваровУслуг.Товары КАК ТаблицаТовары
...
КонецФункции // >> 14.11.2022 Маскаев П.Ю., КРОК, JIRA№ A2105505-742
