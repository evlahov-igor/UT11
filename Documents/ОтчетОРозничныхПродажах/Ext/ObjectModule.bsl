...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	СуммаДокумента = ЦенообразованиеКлиентСервер.ПолучитьСуммуДокумента(
		...
		//Товары,
		КР_ТоварыСУчетомЗаполненияНомераЗаказаИнтернетМагазина(),
		// >> 19.01.2023 Марченко С.Н., КРОК, JIRA№A2105505-725
		ЦенаВключаетНДС);
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если 
	// << 14.03.2023 Марченко С.Н., КРОК, JIRA№A2105505-1405
		ЛОЖЬ И
	// >> 14.03.2023 Марченко С.Н., КРОК, JIRA№A2105505-1405
		ОплатаПлатежнымиКартами.Количество() > 0
		...
		ОбщегоНазначения.СообщитьПользователю(ТекстОшибки, ЭтотОбъект, "ОплатаПлатежнымиКартами", , Отказ);
...
Процедура КР_ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	РегистрыСведений.КР_РеестрДокументовКОтражениюПродажИнтернетМагазина.ЗарегистрироватьОбъект(
		ЭтотОбъект, РежимЗаписи, Отказ);
	
КонецПроцедуры // >> 25.10.2022 Марченко С.Н., КРОК, JIRA№A2105505-725

// << 19.01.2023 Марченко С.Н., КРОК, JIRA№A2105505-725
Функция КР_ТоварыСУчетомЗаполненияНомераЗаказаИнтернетМагазина()
	...
	ОтборСтрок.Вставить("КР_НомерЗаказаИнтернетМагазина", "");
	Возврат Товары.Выгрузить(ОтборСтрок);
	
КонецФункции // >> 19.01.2023 Марченко С.Н., КРОК, JIRA№A2105505-725					
