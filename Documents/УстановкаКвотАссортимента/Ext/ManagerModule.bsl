...
Функция ТекстЗапросаТаблицаКвотыАссортимента(Запрос, ТекстыЗапроса, Регистры)
	...
	|	Склады.Склад КАК ОбъектПланирования,
	// >> 07.01.2023 Федоров Д.Е., КРОК, JIRA№A2105505-921
	...
	// << 07.01.2023 Федоров Д.Е., КРОК, JIRA№A2105505-921
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.УстановкаКвотАссортимента.КР_Склады КАК Склады
	|		ПО ТоварныеКатегории.Ссылка = Склады.Ссылка
	// >> 07.01.2023 Федоров Д.Е., КРОК, JIRA№A2105505-921
	|ГДЕ
...
Функция СуществуетПлан(ПроверяемыйОбъектПланирования, НаДату, ВызывающийДокумент) Экспорт
	...
	// << 07.01.2023 Федоров Д.Е., КРОК, JIRA№A2105505-921
	// В связи с изменением периодичности регистра сведений "КвотыАссортимента", приведение к началу дня не треубется
