...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	// << 07.01.2023 Федоров Д.Е., КРОК, JIRA№A2105505-921
	ИндексОбъектПланирования = ПроверяемыеРеквизиты.Найти("ОбъектПланирования");
	Если ИндексОбъектПланирования <> Неопределено Тогда
		ПроверяемыеРеквизиты.Удалить(ИндексОбъектПланирования);
	КонецЕсли;
	// >> 07.01.2023 Федоров Д.Е., КРОК, JIRA№A2105505-921
