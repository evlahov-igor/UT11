...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ЗначениеЗаполнено(Объект.ТипОплатыКодовМаркировки)
		И Не ИспользуетсяТипОплатыКодовМаркировки(Объект.ВидПродукции, Объект.Организация) Тогда
...
Процедура ОбновитьВидимостьДоступностьЭлементовФормы(Форма)
	...
	Элементы.ТипОплатыКодовМаркировки.Видимость    = ИспользуетсяТипОплатыКодовМаркировки(Объект.ВидПродукции, Объект.Организация);
...
&НаКлиентеНаСервереБезКонтекста
Функция ИспользуетсяТипОплатыКодовМаркировки(ВидПродукции, Организация)
	...
	ИначеЕсли ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.МолочнаяПродукцияБезВЕТИС")
		...
		Результат = Не ОрганизацияЯвляетсяФермером(Организация);
	Иначе
		Результат = Ложь;
	КонецЕсли;
...
&НаСервереБезКонтекста
Функция ОрганизацияЯвляетсяФермером(Организация)
