...
Процедура ПолучитьДанныеПакета()
	...
	Если ЗначениеЗаполнено(СостоянияДокументовЭДО) Тогда
...
Процедура ЗаполнитьДанныеНовогоЭлектронногоДокумента(Основание = Неопределено)
	...
	Если ЗначениеЗаполнено(Основание) Тогда
		...
		Иначе
			...
			// Заполнить договор контрагента, если он один в описание объекта учета по Организации и Контрагенту.
			ОписаниеОбъектаУчета = ИнтеграцияЭДО.ОписаниеОбъектаУчета(Основание);
			СтруктураПоиска = Новый Структура;
			СтруктураПоиска.Вставить("Организация", РеквизитыОснования.Организация);
			СтруктураПоиска.Вставить("Контрагент", РеквизитыОснования.Контрагент);
