...
Процедура ВалютаПриИзмененииСервер(ВалютаНовая)
	...
	КурсыСтарые = РаботаСКурсамиВалютУТ.ПолучитьКурсВалюты(ВалютаДокумента, Объект.Дата, ВалютаРегламентированногоУчета);
	КурсыНовые  = РаботаСКурсамиВалютУТ.ПолучитьКурсВалюты(ВалютаНовая, Объект.Дата, ВалютаРегламентированногоУчета);
