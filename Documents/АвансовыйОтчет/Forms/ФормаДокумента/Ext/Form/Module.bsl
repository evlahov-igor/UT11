...
Процедура ДатаПриИзмененииСервер()
	...
	АктуализироватьСтавкуНДСПрочиеРасходы();
...
Процедура ДобавитьСтрокуПоДаннымБилета(БилетСсылка)
	...
	РеквизитыБилетов.Вставить("Сумма", "СуммаДокумента");
	...
	РеквизитыБилетов.Вставить("СтавкаНДС");
	РеквизитыБилетов.Вставить("СуммаНДС");
	РеквизитыБилетов.Вставить("Контрагент", "КонтрагентПеревозчик");
	
	ЗаполнитьЗначенияСвойств(СтрокаТЧ, ОбщегоНазначения.ЗначенияРеквизитовОбъекта(БилетСсылка, РеквизитыБилетов));
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Поля.Элементы.Добавить().Поле = Новый ПолеКомпоновкиДанных(Элементы.ПрочиеРасходыСпособУчетаНДС.Имя);
...
Процедура ПересчетСуммДокументаВВалютуСервер()
	...
	СтруктураКурсовТекущейВалюты = РаботаСКурсамиВалютУТ.ПолучитьКурсВалюты(ТекущаяВалюта, Объект.Дата, ВалютаРеглУчета);
...
&НаСервере
Процедура АктуализироватьСтавкуНДСПрочиеРасходы()
