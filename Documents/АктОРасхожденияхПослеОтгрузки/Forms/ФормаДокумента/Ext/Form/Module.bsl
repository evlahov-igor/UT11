...
Процедура КонтрагентПриИзмененииСервер()
	...
	Если Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПередачаНаКомиссию Тогда 
		Объект.КР_СкладРазбораРасхождений = 
			Документы.АктОРасхожденияхПослеОтгрузки.КР_ПолучитьСкладРазбораРасхождений(Объект.Контрагент);  
	Иначе 
...
Процедура ПриИзмененииХозяйственнойОперацииСервер()
	...
	// << 28.12.2023 Марченко С.Н., КРОК, JIRA№A2105505-2595
	Элементы.КР_СкладРазбораРасхождений.Видимость = (Объект.ХозяйственнаяОперация = 
...
Процедура УстановитьВидимостьЭлементовПоОперацииСервер()
	...
	ЦеныБезНДС = РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровСХранения(Объект.ТипОснованияАктаОРасхождении)
		Или РасхожденияКлиентСервер.ТипОснованияПередачаТоваровХранителю(Объект.ТипОснованияАктаОРасхождении)
		Или РасхожденияКлиентСервер.ТипОснованияПередачаНаКомиссию(Объект.ТипОснованияАктаОРасхождении);
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "НалогообложениеНДС", "Видимость", Не ЦеныБезНДС);
...
Процедура КР_ПриЧтенииСозданииНаСервере()
	...
	ЭлементФормы.Видимость = (Объект.ХозяйственнаяОперация = 
		ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ПередачаНаКомиссию"));
