...
Процедура УправлениеЭлементамиФормы()
	...
	// Задача #3091
	Элементы.РасходныеКассовыеОрдераГруппаКредитыЗаймы.Видимость 		= Ложь;
	Элементы.РасходныеКассовыеОрдераГруппаПрочее.Видимость 				= Ложь;
	Элементы.РасходныеКассовыеОрдераГруппаВозвраты.Видимость 			= Ложь;
	Элементы.СоздатьРКО.Видимость 										= Ложь;
	Элементы.СоздатьВыдачаДенежныхСредствПодотчетнику.Видимость 		= Ложь;
	Элементы.СоздатьОплатаДенежныхСредствВДругуюОрганизацию.Видимость 	= Ложь;
	Элементы.СоздатьВнутреннююПередачуДенежныхСредств.Видимость 		= Ложь;
	Элементы.СоздатьВыплатаПоВедомостиРаздатчиком.Видимость 			= Ложь;
	Элементы.СоздатьВыплатаПоВедомостиРаботнику.Видимость 				= Ложь;
	Элементы.СоздатьОплатуАрендодателю.Видимость 						= Ложь;
	Элементы.СоздатьСдачаДенежныхСредствВБанк.Видимость 				= Ложь;	
