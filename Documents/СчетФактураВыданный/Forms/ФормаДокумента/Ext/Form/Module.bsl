...
Процедура УправлениеЭлементамиФормы()
	...
	Элементы.ГруппаТовары.Видимость = ЭтоИсправление Или ЭтоКорректировочный Или ЭтоПеревыставление;
	Элементы.ТоварыИсходныйСчетФактура.Видимость = ЭтоИсправление Или ЭтоКорректировочный;
	Элементы.ТоварыПредыдущийСчетФактура.Видимость = ЭтоИсправление Или ЭтоКорректировочный;
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	Для Каждого Строка Из Объект.Товары Цикл
		Строка.ПрослеживаемыйТовар = ЗначениеЗаполнено(Строка.Номенклатура) И Строка.Номенклатура.ПрослеживаемыйТовар;
	КонецЦикла;
