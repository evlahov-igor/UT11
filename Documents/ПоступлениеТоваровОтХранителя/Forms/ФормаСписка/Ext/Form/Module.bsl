...
Процедура ЗаполнитьЗаголовокПоФункциональнойОпции()
	...
	ТекстЗаголовка = ?(ИспользоватьПередачуНаОтветственноеХранениеСПравомПродажи, НСтр("ru = 'хранителей'"), "")
		+ ?(ИспользоватьКомиссиюПриПродажах И ИспользоватьПередачуНаОтветственноеХранениеСПравомПродажи, НСтр("ru = '/'"), "")
		+ ?(ИспользоватьКомиссиюПриПродажах, НСтр("ru = 'комиссионеров'"), "");
	
	Заголовок = СтрШаблон(НСтр("ru = 'Поступление товаров от %1'"),ТекстЗаголовка);
