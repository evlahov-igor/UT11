...
Функция ТекстЗапросаТаблицаСебестоимостьТоваров(Запрос, ТекстыЗапроса, Регистры) Экспорт
	...
	//	партионный учет версии 2.2
	|	(ВЫБОР
	|		КОГДА &Исправление ТОГДА &ИсправляемыйДокумент
	|		ИНАЧЕ &Ссылка КОНЕЦ) КАК Партия,
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "Документы.ПоступлениеТоваровНаСклад.ОбработатьДанныеДляПереходаНаНовуюВерсию";
	Обработчик.Версия = "11.5.5.1";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("baa1dc86-a501-4017-9d7b-33b892634732");
	Обработчик.Многопоточный = Истина;
	Обработчик.ПроцедураЗаполненияДанныхОбновления = "Документы.ПоступлениеТоваровНаСклад.ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию";
	...
	Изменяемые.Добавить(Метаданные.Документы.ПоступлениеТоваровНаСклад.ПолноеИмя());
	Обработчик.ИзменяемыеОбъекты = СтрСоединить(Изменяемые, ",");
	
	Блокируемые = Новый Массив;
	Блокируемые.Добавить(Метаданные.Документы.ПоступлениеТоваровНаСклад.ПолноеИмя());
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ПараметрыВыборки.ПолныеИменаОбъектов = "Документ.ПоступлениеТоваровНаСклад";
	...
	|		ГДЕ
	|			ПоступлениеТоваровНаСклад.Ссылка = ПоступлениеТоваровНаСкладТовары.Ссылка
	|			И ПоступлениеТоваровНаСкладТовары.УдалитьСтавкаНДС <> &ПустаяСтавкаНДС
	|			И ПоступлениеТоваровНаСкладТовары.СтавкаНДС = ЗНАЧЕНИЕ(Справочник.СтавкиНДС.ПустаяСсылка))
	|	ИЛИ ИСТИНА В
	|		(ВЫБРАТЬ ПЕРВЫЕ 1
	|			ИСТИНА
	|		ИЗ
	|			Документ.ПоступлениеТоваровНаСклад.ВидыЗапасов КАК ПоступлениеТоваровНаСкладВидыЗапасов
	|		ГДЕ
	|			ПоступлениеТоваровНаСклад.Ссылка = ПоступлениеТоваровНаСкладВидыЗапасов.Ссылка
	|			И ((ПоступлениеТоваровНаСкладВидыЗапасов.УдалитьСтавкаНДС <> &ПустаяСтавкаНДС
	|			И ПоступлениеТоваровНаСкладВидыЗапасов.СтавкаНДС = ЗНАЧЕНИЕ(Справочник.СтавкиНДС.ПустаяСсылка))
	|			ИЛИ ПоступлениеТоваровНаСкладВидыЗапасов.ИдентификаторСтроки = """")))";
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ПолноеИмяОбъекта        = "Документ.ПоступлениеТоваровНаСклад";
