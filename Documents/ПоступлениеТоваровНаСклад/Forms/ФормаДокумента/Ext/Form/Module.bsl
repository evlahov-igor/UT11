...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// << 04.10.2022 Марченко С.Н., КРОК, JIRA№A2105505-487
...
Процедура КР_ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// КР_ПоступлениеПоОрдеру
	ЭлементФормы = КР_МетодыМодификацииФорм.ВставитьЭлементФормы(ЭтотОбъект,
		"Объект.КР_ПоступлениеПоОрдеру", Элементы.ШапкаПраво); 
	ЭлементФормы.ТолькоПросмотр = Истина; 
	ЭлементФормы.АвтоМаксимальнаяШирина = Ложь;
	ЭлементФормы.МаксимальнаяШирина = 34;

	// КР_ИдентификаторСистемыИсточника
	ЭлементФормы = КР_МетодыМодификацииФорм.ВставитьЭлементФормы(ЭтотОбъект,
		"Объект.КР_ИдентификаторСистемыИсточника", Элементы.ШапкаПраво); 
	ЭлементФормы.ТолькоПросмотр = Истина; 
	ЭлементФормы.АвтоМаксимальнаяШирина = Ложь;
	ЭлементФормы.МаксимальнаяШирина = 34;
	
КонецПроцедуры // >> 04.10.2022 Марченко С.Н., КРОК, JIRA№A2105505-487
