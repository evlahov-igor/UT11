...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыВстраивания = ?(Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.СборкаТоваров,
...
Процедура ВариантОбеспеченияПриИзменении(Элемент)
	...
	Если ВариантОбеспеченияВыбранноеЗначение.ОткрытьФормуВыбораСкладаИСерий Тогда
		...
		ПараметрыФормы = ПараметрыФормыЗапросаКоличестваИСерийКомплекта(ОбеспечениеВДокументахКлиентСервер.РежимВыборДействия());
...
Процедура УстановитьУсловноеОформление()
	...
	ДоступныеОстаткиПараметрыВстраивания = Документы.ЗаказНаСборку.ДоступныеОстаткиПараметрыВстраиванияСборка();
	ОбеспечениеВДокументахСервер.ДоступныеОстаткиДобавитьОформлениеКолонкиДоступно(ЭтотОбъект);
	ДоступныеОстаткиПараметрыВстраивания = Документы.ЗаказНаСборку.ДоступныеОстаткиПараметрыВстраиванияРазборка();
	ОбеспечениеВДокументахСервер.ДоступныеОстаткиДобавитьОформлениеКолонкиДоступно(ЭтотОбъект);
...
Процедура ПослеЗаполненияОбеспеченияКомплекта(Режим = Неопределено)
	...
	ВыполнитьДействияОбеспеченияКомплектаНаСервере("Доступно,СкладОбязателен,ДатаОтгрузкиОбязательна");
...
Процедура ОбработатьВыборСкладаИСерии(ВыбранноеЗначение, ПараметрыФормы) Экспорт
	...
	ПоказатьОповещениеПользователя(ОбеспечениеВДокументахКлиент.ТекстЗаполнениеОбеспечения(), , Оповещение);
