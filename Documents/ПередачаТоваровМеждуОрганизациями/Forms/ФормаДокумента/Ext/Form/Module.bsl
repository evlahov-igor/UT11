...
Процедура РасчетыНажатиеОтправитель(Элемент, СтандартнаяОбработка)
	...
	Иначе
		...
		ЗначенияОтбора = Новый Структура("Покупатель,Продавец,ДокументРасчетов", МассивПокупатели, МассивПоставщики, Объект.ОбъектРасчетов);
		ПараметрыФормы = Новый Структура;
...
Процедура РасчетыНажатиеПолучатель(Элемент, СтандартнаяОбработка)
	...
	Иначе
		...
		ЗначенияОтбора = Новый Структура("Покупатель,Продавец,ДокументРасчетов", МассивПокупатели, МассивПоставщики, Объект.ОбъектРасчетовПолучателя);
		ПараметрыФормы = Новый Структура;
