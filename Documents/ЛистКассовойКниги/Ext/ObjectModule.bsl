...
Процедура КР_ОбработкаЗаполненияДополнительно(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	КассоваяКнига = Документы.ЛистКассовойКниги.КР_ПолучитьКассовуюКнигуКассы(КассоваяКнига);
	
	Документы.ЛистКассовойКниги.КР_ЗаполнитьТипЛистаКассовойКниги(КассоваяКнига, Дата, ТипЛиста);
