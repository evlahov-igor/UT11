...
Процедура ПерепривязатьЭлектронныйДокумент(ВыбранноеЗначение, СпособОбработки)
	...
	ИнтеграцияЭДО.УстановитьСвязьЭлектронногоДокументаСОбъектомУчета(Документооборот, ВыбранноеЗначение);
	...
	Если Элементы.ГруппаНастройкиОтраженияВУчете.Видимость Тогда
		...
		КлючНастройки.ИдентификаторОтправитель = Документооборот.ИдентификаторКонтрагента;
...
&НаСервереБезКонтекста
Процедура ПерезаполнитьОбъектУчета(ОбъектУчета, Документооборот, СпособОбработки) Экспорт
