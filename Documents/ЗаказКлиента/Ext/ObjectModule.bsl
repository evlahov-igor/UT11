...
Функция ЗаполнитьУсловияПродажПоСоглашению(ПересчитватьЦены = Истина) Экспорт
	...
	Если ПересчитватьЦены = Истина Тогда
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	КР_ПроверитьРазрешениеРедактирования(Отказ);
	// >> 18.08.2022, Мельников А.А., КРОК, Jira№ A2105505-39=84 
...
Процедура ОбработкаУдаленияПроведения(Отказ)
	...
	РегистрыСведений.СостоянияЗаказовКлиентов.ОтразитьСостояниеЗаказа(ЭтотОбъект, Отказ, Истина);
...
// Создан: 18.08.2022, Мельников А.А., КРОК, Jira№ A2105505-384 
// Проверяет разрешено ли редактирование данного объекта  
// Параметры: 
// <Отказ> - <Булево>  - Флаг отказа в разрешении редактирования
//
Процедура КР_ПроверитьРазрешениеРедактирования(Отказ) Экспорт
	...
	Документы.ЗаказКлиента.КР_ПроверитьРазрешениеРедактирования(РеквизитыПроверки, Отказ);	
