...
Процедура РазбитьСтроку(Команда)
	...
	Оповещение = Новый ОписаниеОповещения("КР_РазбитьСтрокуЗавершение", ЭтотОбъект);
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	// --> Евлахов Игорь Николаевич (Начало) 06.02.2024
	// Задача #3617
	злПриЧтенииСозданииНаСервереДополнительно();
	// <-- Евлахов Игорь Николаевич (Конец) 06.02.2024
...
#Область злОбработчикиСобытийЭлементовТаблицыФормыТовары
...
// Задача #3617
&НаСервере
Процедура злПриЧтенииСозданииНаСервереДополнительно()
...
Процедура злМодификацияФормы()
	...
	// Блок добавления реквизитов формы
