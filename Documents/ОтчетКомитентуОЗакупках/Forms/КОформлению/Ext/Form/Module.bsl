	...
	Если ВсегоТаблиц > 0 Тогда
		Если РазбивкаПоДокументам.Количество() > 1 Тогда
			...
			Если ДанныеПоРасхождениям.РазличныеОрганизации Тогда
				ТекстОшибки = ТекстОшибки + Символы.ПС+ НСтр("ru = '- различным организациям'");
			КонецЕсли;
			
			Если ДанныеПоРасхождениям.РазличныеКомитенты Тогда
				ТекстОшибки = ТекстОшибки + Символы.ПС+ НСтр("ru = '- различным комитентам (принципалам)'");
			КонецЕсли;
			
			Если ДанныеПоРасхождениям.РазличныеДоговора Тогда
				ТекстОшибки = ТекстОшибки + Символы.ПС+ НСтр("ru = '- различным договорам'");
			КонецЕсли;
			
			Если ДанныеПоРасхождениям.РазличнаяВалюта Тогда
				ТекстОшибки = ТекстОшибки + Символы.ПС+ НСтр("ru = '- различным валютам'");
			КонецЕсли;
...
Функция РазделитьСписокНазначенийПоОтчетам()
	...
	ПараметрыУникальныхДокументов = СписокНазначений.Выгрузить(,"Организация, Комитент, ДоговорСКомитентом, КонтрагентКомитент, Валюта, НаправлениеДеятельности, НалогообложениеНДС, ЦенаВключаетНДС, Соглашение");
	ПараметрыУникальныхДокументов.Свернуть("Организация, Комитент, ДоговорСКомитентом, КонтрагентКомитент, Валюта, НаправлениеДеятельности, НалогообложениеНДС, ЦенаВключаетНДС, Соглашение", "");
