...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|- в планах в статусе ""Утвержден"" отмечается флаг ""Замещен к заказу"", если для плана есть планы в статусе ""Утвержден""
	...
	|Заполняет варианты отсчета графика оплаты и заменяет вариант оплаты ""Кредит (плановый)"" на ""Кредит (после отгрузки)"".'");
...
Функция ТекстЗапросаДанныеКОбработке(ВыбратьДляРегистрацииДвиженийОборотыДвижений = Ложь) Экспорт
	...
	|ИЗ
	|	Документ.ПланЗакупок.ЭтапыГрафикаОплаты КАК ЭтапыГрафикаОплаты
	|ГДЕ
	|	ЭтапыГрафикаОплаты.ВариантОтсчета = ЗНАЧЕНИЕ(Перечисление.ВариантыОтсчетаДатыПлатежа.ПустаяСсылка)";
