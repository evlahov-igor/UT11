...
Функция ТекстЗапросаТаблицаСебестоимостьТоваров(Запрос, ТекстыЗапроса, Регистры) Экспорт
	...
	ТекстЗапроса = "
	// Данные для возврата товаров без документа реализации.	
	|ВЫБРАТЬ
	|	0 																КАК Порядок,
	...
	|ОБЪЕДИНИТЬ ВСЕ
	|
	// Данные для возврата работ без документа реализации.	
	|ВЫБРАТЬ
	|	1 КАК Порядок,
	...
	|	0 																КАК НДСРегл,
	|	НЕОПРЕДЕЛЕНО 													КАК КорАналитикаФинансовогоУчета,
	|	ТаблицаВидыЗапасов.НалогообложениеНДСРеализации  				КАК КорВидДеятельностиНДС,
	...
	|ОБЪЕДИНИТЬ ВСЕ
	|
	// Данные для возврата работ по документу реализации.	
	|ВЫБРАТЬ
	|	4 КАК Порядок,
	|	ТаблицаТовары.НомерСтроки КАК НомерСтрокиДокумента,
	|	ЗНАЧЕНИЕ(ВидДвиженияНакопления.Расход) КАК ВидДвижения,
	...
	|	0 																КАК НДСРегл,
	|	НЕОПРЕДЕЛЕНО 													КАК КорАналитикаФинансовогоУчета,
	|	ТаблицаТовары.НалогообложениеНДСРеализации						КАК КорВидДеятельностиНДС,
