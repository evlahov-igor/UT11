...
Функция КР_НастроитьСписок()
	...
	ТекстПоиска = "ДокументПересортицаТоваров.Ссылка,";
	ТекстЗамены = "ДокументПересортицаТоваров.Ссылка,"
		+ Символы.ПС + Символы.Таб + "ДокументПересортицаТоваров.КР_ЗакрытиеОтрицательныхОстатков,";
