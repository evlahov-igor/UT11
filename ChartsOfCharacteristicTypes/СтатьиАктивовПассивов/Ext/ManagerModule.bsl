...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("c2228d01-4a2a-44ca-891a-e621c2762e29");
...
Процедура ЗарегистрироватьПредопределенныеЭлементыДляОбновления(Параметры) Экспорт
	...
	ОбновлениеИнформационнойБазыУТ.ЗарегистрироватьПредопределенныеЭлементыДляОбновления(Параметры, Метаданные.ПланыВидовХарактеристик.СтатьиАктивовПассивов);
	
КонецПроцедуры

Процедура ЗаполнитьЭлементыНачальнымиДанными(Параметры) Экспорт
	
	ОбновлениеИнформационнойБазыУТ.ЗаполнитьЭлементыНачальнымиДанными(Параметры, Метаданные.ПланыВидовХарактеристик.СтатьиАктивовПассивов, Ложь, "Наименование");
...
Функция ПорядокСтатей()
	...
	ДобавитьЗапись(Таблица, "НезавершенноеПроизводство", "34");
	ДобавитьЗапись(Таблица, "РасходыБудущихПериодов", "35");
	ДобавитьЗапись(Таблица, "РасходыТекущегоПериода", "36");
	ДобавитьЗапись(Таблица, "ДоходыТекущегоПериода", "37");
	ДобавитьЗапись(Таблица, "ПрибылиИУбытки", "38");
	ДобавитьЗапись(Таблица, "ВнеоборотныеАктивы", "39");
	ДобавитьЗапись(Таблица, "ОсновныеСредства", "40");
	ДобавитьЗапись(Таблица, "НематериальныеАктивы", "41");
	ДобавитьЗапись(Таблица, "КапитализацияОС", "42");
	ДобавитьЗапись(Таблица, "КапитализацияОбъектовСтроительства", "43");
	ДобавитьЗапись(Таблица, "КапитализацияНМАиНИОКР", "44");
	ДобавитьЗапись(Таблица, "ГруппаПрочиеАктивы", "45");
	ДобавитьЗапись(Таблица, "ПрочиеАктивы", "46");
	ДобавитьЗапись(Таблица, "ГруппаПрочиеПассивы", "47");
	ДобавитьЗапись(Таблица, "ПрочиеПассивы", "48");
	ДобавитьЗапись(Таблица, "Налоги", "49");
	ДобавитьЗапись(Таблица, "ДепонированнаяЗарплата", "50");
	ДобавитьЗапись(Таблица, "ОплатаТруда", "51");
	ДобавитьЗапись(Таблица, "РезервыПоСомнительнымДолгам", "52");
	ДобавитьЗапись(Таблица, "ТоварыРаботыКОформлениюОтчетовКомитенту", "53");
	ДобавитьЗапись(Таблица, "НДСПоОтгрузкамБезПереходаПраваСобственности", "54");
	ДобавитьЗапись(Таблица, "РасчетыСФилиалами", "55");
	ДобавитьЗапись(Таблица, "РасчетыПоВыделенномуИмуществу", "56");
	ДобавитьЗапись(Таблица, "РезервыПоВознаграждениям", "57");
	ДобавитьЗапись(Таблица, "РезервыПоСтраховымВзносам", "58");
	ДобавитьЗапись(Таблица, "РасходыДисконтирования", "59");
