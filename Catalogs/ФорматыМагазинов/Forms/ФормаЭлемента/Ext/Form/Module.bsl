...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИспользоватьНесколькоВидовЦен Тогда		
		...
		НастроитьВидимостьДоступностьЭлементовНастройкиРозничногоВидаЦен(ЭтаФорма);
...
&НаКлиенте
Процедура ИспользоватьРозничныйВидЦеныПриИзмененииНаКлиенте()

	Если НЕ ИспользоватьРозничныйВидЦены Тогда
		
		Объект.РозничныйВидЦены = ПредопределенноеЗначение("Справочник.ВидыЦен.ПустаяСсылка");
...
&НаКлиенте
Процедура ИспользоватьРозничныйВидЦеныПриИзменении(Элемент)
	
	ИспользоватьРозничныйВидЦеныПриИзмененииНаКлиенте();
	НастроитьВидимостьДоступностьЭлементовНастройкиРозничногоВидаЦен(ЭтаФорма);
...
Процедура ОбновитьФлажокИспользоватьРозничныйВидЦены()
	...
	ИспользоватьРозничныйВидЦены = ЗначениеЗаполнено(Объект.РозничныйВидЦены);
...
&НаКлиентеНаСервереБезКонтекста
Процедура НастроитьВидимостьДоступностьЭлементовНастройкиРозничногоВидаЦен(Форма)
	
	Форма.Элементы.РозничныйВидЦены.Доступность = (Форма.ИспользоватьРозничныйВидЦены И Не Форма.Элементы.ИспользоватьРозничныйВидЦены.ТолькоПросмотр);
