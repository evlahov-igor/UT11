...
Процедура ПриЗаписи(Отказ)
	...
	Если ЗначениеЗаполнено(ЭтотОбъект.ВалютаРегламентированногоУчета) Тогда
		РаботаСКурсамиВалютУТ.ПроверитьКорректностьОтносительногоКурсаНа01_01_1980(ЭтотОбъект.ВалютаРегламентированногоУчета);
	КонецЕсли;
