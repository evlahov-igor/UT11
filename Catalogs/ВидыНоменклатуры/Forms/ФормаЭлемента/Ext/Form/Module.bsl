...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	злНеПечататьEACЭлемент = КР_МетодыМодификацииФорм.ВставитьЭлементФормы(ЭтотОбъект, "Объект.злНеПечататьEAC", Элементы.СтраницаОсновное);		// #4670.. Фомин Д.Ю. 04.09.2024.
...
Функция ПоместитьВХранилищеРеквизитыДляКлючаЦен()
	...
	Возврат ПоместитьВоВременноеХранилище(ТаблицаРеквизитовКлючаЦен, ЭтаФорма.УникальныйИдентификатор);
...
Процедура КР_ПриЧтенииСозданииНаСервереДополнительно()
	...
	КодЭлемент = КР_МетодыМодификацииФорм.ВставитьЭлементФормы(
		ЭтотОбъект, "Объект.Код", Элементы["СтраницаОсновное"], Элементы["Наименование"]);
