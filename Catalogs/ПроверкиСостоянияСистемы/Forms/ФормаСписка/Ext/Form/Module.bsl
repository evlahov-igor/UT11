...
Функция РезультатПроверкиВДлительнойОперации(Знач МассивПроверок)
	...
	Для к = 1 По ВсегоЭлементовМассива Цикл
		...
		ОписаниеДополнительныхПараметров = ЭлементМассива.ОписаниеДополнительныхПараметров; // ХранилищеЗначения
		ОписаниеДопПараметров = ОписаниеДополнительныхПараметров.Получить();
