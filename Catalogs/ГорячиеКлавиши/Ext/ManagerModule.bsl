...
Процедура ЗаполнитьТабличныйДокументПоДаннымОбъекта(ТабличныйДокумент, ДанныеОбъекта)
	...
	БыстрыеТовары = ДанныеОбъекта.БыстрыеТовары.Получить(); // ТаблицаЗначений - см. Справочники.ГорячиеКлавиши.ФормаЭлемента.БыстрыеТовары
	...
	КомандыФормы = ДанныеОбъекта.КомандыФормы.Получить(); // ТаблицаЗначений - см. Справочники.ГорячиеКлавиши.ФормаЭлемента.КомандыФормы
