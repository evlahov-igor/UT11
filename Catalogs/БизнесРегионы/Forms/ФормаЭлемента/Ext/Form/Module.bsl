...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// << 02.09.2022 Марченко С.Н., КРОК, JIRA№A2105505-434   
...
Процедура КР_ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)  
	...
	// КР_ЧисленностьНаселения 
	ЭлементФормы = КР_МетодыМодификацииФорм.ВставитьЭлементФормы(ЭтотОбъект,
		"Объект.КР_ЧисленностьНаселения", , Элементы.ГруппаДополнительныеРеквизиты);	 	
	
КонецПроцедуры // >> 02.09.2022 Марченко С.Н., КРОК, JIRA№A2105505-434
