...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// << 08.09.2022, Маскаев П.Ю., КРОК, Jira№ A2105505-324
	// Изменение формы
...
Процедура КР_ПриЧтенииСозданииНаСервереДополнительно()
	...
	КодЭлемент = КР_МетодыМодификацииФорм.ВставитьЭлементФормы(
		ЭтотОбъект, "Объект.Код", ЭтотОбъект, Элементы["Наименование"]);
	
	// КР_Сезон
	КР_СезонЭлемент = КР_МетодыМодификацииФорм.ВставитьЭлементФормы(
		ЭтотОбъект, "Объект.КР_Сезон", ЭтотОбъект, Элементы["ГруппаДатаНачалаОкончания"]);
	
	// КР_ВремяГодаКалендарное
	КР_ВремяГодаКалендарноеЭлемент = КР_МетодыМодификацииФорм.ВставитьЭлементФормы(
		ЭтотОбъект, "Объект.КР_ВремяГодаКалендарное", ЭтотОбъект, Элементы["ГруппаДатаНачалаОкончания"]);
		
	// << 12.01.2023, Федоров Д.Е., КРОК, Jira№ A2105505-775
	// КР_Приоритет
	КР_ПриоритетЭлемент = КР_МетодыМодификацииФорм.ВставитьЭлементФормы(
		ЭтотОбъект, "Объект.КР_Приоритет", ЭтотОбъект, Элементы["ГруппаДатаНачалаОкончания"]);
	// >> 12.01.2023, Федоров Д.Е., КРОК, Jira№ A2105505-775
