...
&НаКлиенте
Процедура ЭквайринговыеТерминалыПриИзменении(Элемент)
	
	Объект.ИспользуютсяЭквайринговыеТерминалы = Булево(ЭквайринговыеТерминалы);
	
	Если Объект.ИспользуютсяЭквайринговыеТерминалы Тогда
		ЭквайринговыеТерминалыПриИзмененииНаСервере();
	Иначе
		НастроитьЗависимыеЭлементыФормы("ИспользуютсяЭквайринговыеТерминалы");
	КонецЕсли;
	
КонецПроцедуры

&НаСервере
Процедура ЭквайринговыеТерминалыПриИзмененииНаСервере()
	
	СформироватьНадписьЭквайринговыеТерминалы();
	НастроитьЗависимыеЭлементыФормыНаСервере("ИспользуютсяЭквайринговыеТерминалы");
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	ЭквайринговыеТерминалы = Число(Объект.ИспользуютсяЭквайринговыеТерминалы);
