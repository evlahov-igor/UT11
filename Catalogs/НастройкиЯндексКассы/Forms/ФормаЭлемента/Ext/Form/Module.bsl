...
&НаКлиенте
Процедура СсылкаНастройкиМагазинаОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
...
Процедура ОткрытьСтраницуНастройкиКастомизации()
	...
	АдресРезультат = АдресКастомизацииСтраницыОплаты(ИдентификаторМагазина);
...
&НаСервереБезКонтекста
Функция АдресКастомизацииСтраницыОплаты(Знач ИдентификаторМагазина)
	
	Результат = ИнтеграцияСЯндексКассойСлужебный.АдресКастомизацииСтраницыОплаты(ИдентификаторМагазина);
