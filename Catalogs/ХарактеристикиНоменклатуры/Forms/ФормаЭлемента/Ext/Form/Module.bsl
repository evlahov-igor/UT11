...
Процедура КР_ПриЧтенииСозданииНаСервереДополнительно()
	...
	// КР_Размер
	КР_РазмерЭлемент = КР_МетодыМодификацииФорм.ВставитьЭлементФормы(
		ЭтотОбъект, "Объект.КР_Размер", ЭтотОбъект, Элементы["ГруппаРабочееНаименование"]);
	
	// КР_КодТНВЭД
	КР_КодТНВЭДЭлемент = КР_МетодыМодификацииФорм.ВставитьЭлементФормы(
		ЭтотОбъект, "Объект.КР_КодТНВЭД", ЭтотОбъект, Элементы["ГруппаРабочееНаименование"]);
		
	// << 09.08.2023 Марченко С.Н., КРОК, JIRA№A2105505-1802    
	
	// КР_Штрихкод
	ЭлементФормы = КР_МетодыМодификацииФорм.ВставитьЭлементФормы(ЭтотОбъект,
		"Объект.КР_Штрихкод", ,Элементы.ГруппаЦенообразование);
